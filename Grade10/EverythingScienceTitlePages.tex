...
See introductory video by Dr. Mark Horner: \raisebox{-0.2em}{\includegraphics[height=1em]{../icons/video.pdf}} VPsfk  at www.everythingscience.co.za
...
To read or download it, go to \underline{www.everythingscience.co.za} on your phone or computer.} \vspace*{1cm}
...
To watch the videos on-line, practise your skills or post a question, go to the \textit{Everything Science} website at \underline{www.everythingscience.co.za} on your mobile or PC and enter the short-code in the navigation box.
}
...
\begin{center}
 See video exercise \raisebox{-0.6em}{\includegraphics[width=0.7cm]{../icons/video.pdf}} (Video: V123) \vspace {0.5cm}\\
...
\begin{center}
See more practice \raisebox{-0.6em}{\includegraphics[width=0.7cm]{../icons/aplus.pdf}} (QM123) \vspace{0.5cm}\\
\includegraphics[width=0.6\textwidth]{title_images/practicephones.png}
\end{center}
\par
...
\end{tabular}
\vspace{1cm}\\
{\normalfont\sffamily\fontsize{16}\normalfont\itshape Ask an expert} \par
...
use the short-code for the section or exercise in the book to identify your problem area.\par
