...
\newpsstyle{fred} {linestyle=none,fillstyle=solid,fillcolor=blue}
\newpsstyle{george} {linestyle=none,fillstyle=solid,fillcolor=orange}
...
\Warning{${\mathsf{AgNO}}_{3}$ stains the skin. Be careful when working with it or use gloves.}
	\par
