...
\newpsstyle{white} {linestyle=solid,linewidth=.1,fillstyle=solid,fillcolor=white}
 \pstTubeEssais[etiquette,Numero={ $\mathsf{AgNO}_{2}$},aspectLiquide1=white]
...
\scalebox{.7}{
  \begin{pspicture}(0,0)(5,5)
\newpsstyle{white} {linestyle=solid,linewidth=.1,fillstyle=solid,fillcolor=white}
 \pstTubeEssais[etiquette,Numero={ $\mathsf{NaOH}$},aspectLiquide1=white]
\pstTubeEssais[etiquette,Numero={ $\mathsf{HCl}$},aspectLiquide1=white]    
  \end{pspicture}
}
 \end{center}
\end{minipage}
...
\scalebox{.6}{
  \begin{pspicture}(0,0)(5,5)
\newpsstyle{white} {linestyle=solid,linewidth=.1,fillstyle=solid,fillcolor=white}
 \pstTubeEssais[etiquette,Numero={ $\mathsf{H}_{2}\mathsf{O}$},aspectLiquide1=white]
...
\item $0,1~\mathsf{M}$ silver nitrate ($\mathsf{AgNO}_3$)
\item $0,1~\mathsf{M}$ sodium chloride ($\mathsf{NaCl}$)
\item $0,1~\mathsf{M}$ lead nitrate ($\mathsf{PbNO}_{3}$)
\item $0,1~\mathsf{M}$ sodium iodide ($\mathsf{NaI}$)
\item $0,1~\mathsf{M}$ iron (III) chloride ($\mathsf{FeCl}_{3}$)
\item $0,1~\mathsf{M}$ sodium hydroxide ($\mathsf{NaOH}$)
\item 9 test tubes
\item 3 propettes
\end{itemize}
\end{minipage} 
...
%Silver nitrate
 \pstTubeEssais[etiquette,Numero={ $\mathsf{AgNO}_3$},aspectLiquide1=white,niveauLiquide1=10]
\pstTubeEssais[etiquette,Numero={ $\mathsf{AgNO}_3$},aspectLiquide1=white,niveauLiquide1=15] 
 \pstTubeEssais[etiquette,Numero={ $\mathsf{AgNO}_3$},aspectLiquide1=white,niveauLiquide1=20]
%Lead nitrate
\pstTubeEssais[etiquette,Numero={$\mathsf{PbNO}_{3}$},aspectLiquide1=white,niveauLiquide1=10]  
 \pstTubeEssais[etiquette,Numero={$\mathsf{PbNO}_{3}$},aspectLiquide1=white,niveauLiquide1=15]
\pstTubeEssais[etiquette,Numero={$\mathsf{PbNO}_{3}$},aspectLiquide1=white,niveauLiquide1=20]
% Iron (III) chloride
 \pstTubeEssais[etiquette,Numero={$\mathsf{FeCl}_{3}$},aspectLiquide1=orange,niveauLiquide1=10]
\pstTubeEssais[etiquette,Numero={$\mathsf{FeCl}_{3}$},aspectLiquide1=orange,niveauLiquide1=15]  
 \pstTubeEssais[etiquette,Numero={$\mathsf{FeCl}_{3}$},aspectLiquide1=orange,niveauLiquide1=20] 
  \end{pspicture}
}
 \end{center}
\end{minipage}
