...
\label{m38709*secfhsst!!!underscore!!!id163}
	...
	\begin{figure}[H] % horizontal\label{m38709*id63200}
    \begin{center}
\includegraphics[width=.4\textwidth]{photos/hydrogen_balloon1.jpg} 
\includegraphics[width=.4\textwidth]{photos/hydrogen_balloon2_argonnenationallaboratory.jpg} \\
...
\end{enumerate}
\Warning{This reaction can be highly explosive, for this reason it is best done outdoors. Always ensure that you wear ear protection or block your ears and have more oxygen than hydrogen in the balloon.}
        \par 
        \label{m38709*id63254}\noindent{}\textbf{Results:}\newline
...
\end{exercises}
    ...
    \label{m38711*cid5}
            ...
            \nopagebreak
      \label{m38711*id64489}In a chemical reaction the total mass of the all the substances taking part in the reaction remains the same. Also, the number of \textbf{atoms} in a reaction remains the same. Mass cannot be created or destroyed in chemical reaction.\par 
...
\begin{itemize}[noitemsep]
 \item silver nitrate ($\mathsf{AgNO}_3$)
\item sodium chloride ($\mathsf{NaCl}$)
\item lead nitrate ($\mathsf{PbNO}_{3}$)
\item sodium iodide ($\mathsf{NaI}$)
\item iron (III) chloride ($\mathsf{FeCl}_{3}$)
\item sodium hydroxide ($\mathsf{NaOH}$)
\item 10 test tubes
\item glass beaker
\item 2 propettes
\end{itemize} \\
\textbf{Method:}\\
\textsl{Reaction 1:} Prepare three test tubes with $5~\mathsf{ml}$, $10~\mathsf{ml}$ and $15~\mathsf{ml}$  of silver nitrate respectively. Add $5~\mathsf{g}$ of sodium chloride to each one and observe what happens. Write a balanced equation for this reaction.
\textsl{Reaction2:} Prepare three test tubes with $5~\mathsf{ml}$, $10~\mathsf{ml}$ and $15~\mathsf{ml}$  of lead nitrate respectively. Add $5~\mathsf{g}$ of sodium iodide to each one and observe what happens. Write a balanced equation for this reaction.
\textsl{Reaction 3:} Prepare three test tubes with $5~\mathsf{ml}$, $10~\mathsf{ml}$ and $15~\mathsf{ml}$  of sodium hydroxide respectively. Add $5~\mathsf{g}$ of iron(III) chloride to each one and observe what happens. Write a balanced equation for this reaction. \\
