...
\end{minipage}
\end{activity}
\Note{http://www.fhsst.org/lDo is a website that allows you to view several compounds. You do not need to know these compounds, this is simply to allow you to see one way of representing compounds.}
