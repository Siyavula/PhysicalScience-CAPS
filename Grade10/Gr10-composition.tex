...
reasons for this in earlier chapters.\par \pagebreak
...
Almost everything around us is made up of compounds. Compounds are formed when two or more atoms combine in fixed proportions. Compounds can be divided into \textbf{molecular compounds} (molecules), \textbf{ionic compounds} (salts) and \textbf{metallic compounds} (metals).
...
would be written as ${\text{CH}}_{2}\text{O}$. This is called the \textbf{empirical formula} of the molecule.
\vspace{\rubberspace}\par
