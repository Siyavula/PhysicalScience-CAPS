    ...
    \section{Introduction}
            \nopagebreak
%            \label{m38138*cid2} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10107 )} \par 
...
\end{minipage}
      ...
      \label{m38138*id8754}
      \IFact{The total mass of the hydrosphere is approximately $1,4~{\times}{10}^{18} ~~ \text{tonnes}$! (The volume of one tonne of water is approximately 1 cubic metre (this is about 900 A4 textbooks!))}
	\par
    \section{Interactions of the hydrosphere}
            \nopagebreak
%            \label{m38138*cid3} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10108 )} \par 
...
\end{itemize}
    ...
    \section{Exploring the hydrosphere}
            \nopagebreak
%            \label{m38138*cid4} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10109 )} \par 
...
\end{Investigation}
    \section{The importance of the hydrosphere}
            \nopagebreak
%            \label{m38138*cid5} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10110 )} \par 
...
\end{itemize}
    ...
    \section{Threats to the hydrosphere}
            \nopagebreak
%            \label{m38138*cid10} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10111 )} \par 
...
\section{How pure is our water?}
            \nopagebreak
%            \label{m38138*id083432} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10112 )} \par 
...
\summary{zzz}
            \nopagebreak
%            \label{m38138*cid11} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10113 )} \par 
...
\begin{eocexercises}{The hydrosphere}
            \nopagebreak
%            \label{m38138*id6239} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10114 )} \par 
