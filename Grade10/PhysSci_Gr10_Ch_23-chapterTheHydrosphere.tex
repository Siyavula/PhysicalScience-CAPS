...
\begin{tabular}{cc}
	...
	\begin{note}
      {note: }The total mass of the hydrosphere is approximately \begin{math}1,4\ensuremath{\times}{10}^{18}\phantom{\rule{2pt}{0ex}}\mathrm{tonnes}\end{math}! (The volume of one tonne of water is approximately 1 cubic metre.)
	\end{note}
	\end{minipage}
	\end{tabular}
	\par
...
\label{m38138*secfhsst!!!underscore!!!id86}
            \subsection{  Investigation : Investigating the hydrosphere
      }
            \nopagebreak
...
Record your data in a table like the one shown below:
    ...
    \end{tabular}
      \end{center}
    \begin{center}{\small\bfseries Table 22.1}\end{center}
    %\end{table}
...
\label{m38138*uid13}\item Water is seldom 'pure'. It usually has lots of things dissolved (e.g. \begin{math}{Mg}^{2+}\end{math}, \begin{math}{Ca}^{2+}\end{math} and \begin{math}\mathrm{NO}_{3}^{-}\end{math} ions) or suspended (e.g. soil particles, debris) in it. Where do these substances come from?
...
The hydrosphere provides an important place for many animals and plants to live. Many gases (e.g. \begin{math}{\mathrm{CO}}_{2}\end{math}, \begin{math}{\mathrm{O}}_{2}\end{math}), nutrients e.g. nitrate (\begin{math}\mathrm{NO}_{3}^{-}\end{math}), nitrite (\begin{math}\mathrm{NO}_{2}^{-}\end{math}) and ammonium (\begin{math}\mathrm{NH}_{4}^{+}\end{math}) ions, as well as other ions (e.g. \begin{math}{Mg}^{2+}\end{math} and \begin{math}{Ca}^{2+}\end{math}) are dissolved in water. The presence of these substances is critical for life to exist in water.
...
\label{m38138*secfhsst!!!underscore!!!id1046}
            \subsection{  Discussion : Creative water conservation
}
            \nopagebreak
...
\label{m38138*id0123}
            \subsection{ Investigation: Building of dams}
            \nopagebreak
...
\label{m38138*secfhsst!!!underscore!!!id1065}
            \subsection{  Group Project : School Action Project
      }
            \nopagebreak
...
In Reactions in aqueous solutions\footnote{\raggedright{}"Reactions in aqueous solutions - Grade 10 [CAPS]" <http://http://cnx.org/content/m38136/latest/>} we saw how compounds can dissolve in water. Most of these compounds (e.g. \begin{math}{\mathrm{Na}}^{+}\end{math}, \begin{math}{\mathrm{Cl}}^{-}\end{math}, \begin{math}{\mathrm{Ca}}^{2+}\end{math}, \begin{math}{\mathrm{Mg}}^{2+}\end{math}, etc.) are safe for humans to consume in the small amounts that are naturally present in water. It is only when the amounts of these ions rise above the safe levels that the water is considered to be polluted.
\par 
...
\label{m38138*id08321}
            \subsection{ Experiment: Water purity}
            \nopagebreak
...
\label{m38138*id672214}
            \subsection{ Project: water purification}
            \nopagebreak
