...
\label{m38771*id62893}
    \begin{center}
    \label{m38771*id62893!!!underscore!!!media}\label{m38771*id62893!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_001.png} % m38771;PG10C9\_001.png;;;6.0;8.5;
...
\label{m38771*id62930}
    \begin{center}
    \label{m38771*id62930!!!underscore!!!media}\label{m38771*id62930!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_002.png} % m38771;PG10C9\_002.png;;;6.0;8.5;
...
\label{m38771*id62966}
    \begin{center}
    \label{m38771*id62966!!!underscore!!!media}\label{m38771*id62966!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_003.png} % m38771;PG10C9\_003.png;;;6.0;8.5;
...
\label{m38771*id63001}
    \begin{center}
    \label{m38771*id63001!!!underscore!!!media}\label{m38771*id63001!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_004.png} % m38771;PG10C9\_004.png;;;6.0;8.5;
...
\label{m38771*id63056}
    \begin{center}
    \label{m38771*id63056!!!underscore!!!media}\label{m38771*id63056!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_005.png} % m38771;PG10C9\_005.png;;;6.0;8.5;
...
\label{m38771*id63089}
    \begin{center}
    \label{m38771*id63089!!!underscore!!!media}\label{m38771*id63089!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_006.png} % m38771;PG10C9\_006.png;;;6.0;8.5;
...
\label{m38771*id63126}
    \begin{center}
    \label{m38771*id63126!!!underscore!!!media}\label{m38771*id63126!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_007.png} % m38771;PG10C9\_007.png;;;6.0;8.5;
...
\label{m38771*id63163}
    \begin{center}
    \label{m38771*id63163!!!underscore!!!media}\label{m38771*id63163!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_008.png} % m38771;PG10C9\_008.png;;;6.0;8.5;
...
\par
 ...
 \par 
    ...
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38771*uid14!!!underscore!!!media}\label{m38771*uid14!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_PG10C9_009.png} % m38771;PG10C9\_009.png;;;6.0;8.5;
 ...
 \end{figure}   
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38771*uid15!!!underscore!!!media}\label{m38771*uid15!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38771_PG10C9_010.png} % m38771;PG10C9\_010.png;;;6.0;8.5;
...
\label{m38771*fs-id5490818}This simulation allows you to experiment with building circuits.
	...
	\begin{figure}[H] % horizontal\label{m38771*id63458211}
    \begin{center}
    \label{m38771*id6345821!!!underscore!!!media}\label{m38771*id6345821!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38771_circuit-kit.png} % m38771;circuit-kit.png;;;6.0;8.5;
...
\par 
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38772*uid73s1!!!underscore!!!media}\label{m38772*uid73s1!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38772_PG10C9_034.png} % m38772;PG10C9\_034.png;;;6.0;8.5;
...
\par
    ...
    \begin{center}
    \label{m38772*id64742!!!underscore!!!media}\label{m38772*id64742!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38772_PG10C9_021.png} % m38772;PG10C9\_021.png;;;6.0;8.5;
...
\par
            \label{m38772*secfhsst!!!underscore!!!id788}\vspace{.5cm} 
    ...
    \begin{center}
    \label{m38772*id65109!!!underscore!!!media}\label{m38772*id65109!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38772_PG10C9_022.png} % m38772;PG10C9\_022.png;;;6.0;8.5;
...
\par
    ...
    \begin{center}
    \label{m38772*id65568!!!underscore!!!media}\label{m38772*id65568!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38772_PG10C9_023.png} % m38772;PG10C9\_023.png;;;6.0;8.5;
...
\par
    ...
    \begin{center}
    \label{m38772*id66094!!!underscore!!!media}\label{m38772*id66094!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38772_PG10C9_024.png} % m38772;PG10C9\_024.png;;;6.0;8.5;
...
\label{m38773*fhsst!!!underscore!!!id1564}\begin{definition}
    ...
    \begin{center}
    \label{m38773*id66814!!!underscore!!!media}\label{m38773*id66814!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38773_PG10C9_026.png} % m38773;PG10C9\_026.png;;;6.0;8.5;
...
measurement is made.\par 
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38773*uid73!!!underscore!!!media}\label{m38773*uid73!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38773_PG10C9_034.png} % m38773;PG10C9\_034.png;;;6.0;8.5;
...
component (Figure~16.24). The positive lead from the ammeter must be connected closest to the positive end of the battery and the negative lead must be connected closest to the negative end of the battery.\par 
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38773*uid75!!!underscore!!!media}\label{m38773*uid75!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38773_PG10C9_035.png} % m38773;PG10C9\_035.png;;;6.0;8.5;
...
The sum of the potential differences across each individual resistor is equal to the potential difference measured across all of them together. For this reason, series circuits are sometimes called \textbf{voltage dividers}.\par 
    ...
    \begin{center}
    \label{m38776*id64087!!!underscore!!!media}\label{m38776*id64087!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38776_PG10C9_018.png} % m38776;PG10C9\_018.png;;;6.0;8.5;
...
Consider a circuit consisting of three resistors and a single cell connected in series.\par 
    ...
    \begin{center}
    \label{m38776*id63934!!!underscore!!!media}\label{m38776*id63934!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38776_PG11C9_007.png} % m38776;PG11C9\_007.png;;;6.0;8.5;
...
Let us apply the rule of equivalent resistance in a series circuit to the following circuit.\par 
    ...
    \begin{center}
    \label{m38776*id64726!!!underscore!!!media}\label{m38776*id64726!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38776_PG11C9_008.png} % m38776;PG11C9\_008.png;;;6.0;8.5;
...
\end{itemize}
    ...
    \begin{center}
    \label{m38776*id66976!!!underscore!!!media}\label{m38776*id66976!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38776_PG10C9_027.png} % m38776;PG10C9\_027.png;;;6.0;8.5;
...
\label{m38776*secfhsst!!!underscore!!!id1001}\vspace{.5cm} 
 ...
 \end{figure}   
    ...
    \begin{center}
    \label{m38776*id64026!!!underscore!!!media}\label{m38776*id64026!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38776_PG10C9_016.png} % m38776;PG10C9\_016.png;;;6.0;8.5;
...
\end{itemize}
    ...
    \begin{center}
    \label{m38776*id67166!!!underscore!!!media}\label{m38776*id67166!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38776_PG10C9_030.png} % m38776;PG10C9\_030.png;;;6.0;8.5;
...
\end{enumerate}
    ...
    \begin{center}
    \label{m38776*id6854!!!underscore!!!media}\label{m38776*id6854!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38776_circuit1.png} % m38776;circuit1.png;;;6.0;8.5;
