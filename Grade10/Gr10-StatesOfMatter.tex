         \chapter{States of matter and the kinetic molecular theory}\fancyfoot[LO,RE]{Focus Area: Chemistry}
    \setcounter{figure}{1}
...
(gas). Note that in the Figure \ref{fig:threephases} below the 
...
\multirput(0.2,0.6)(0.4,0){7}{\pscircle(0,0){0.2}}
\multirput(0.2,1)(0.4,0){7}{\pscircle(0,0){0.2}}
\multirput(0.4,0.8)(0.4,0){6}{\pscircle(0,0){0.1}}
\multirput(0.4,0.4)(0.4,0){6}{\pscircle(0,0){0.1}}}}
