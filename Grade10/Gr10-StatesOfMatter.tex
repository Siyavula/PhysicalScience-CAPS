...
point (${}^{\ensuremath{{\,}^{\circ}}}\mathrm{C}$)} &
        \textbf{Boiling point (${}^{\ensuremath{{\,}^{\circ}}}\mathrm{C}$)}% make-rowspan-placeholders
...
114,3 &
    ...
    \begin{caption}{\small\bfseries Table 2.2}: The melting and boiling 
\end{table}
...
to the table and then answer the questions that follow.
    ...
    \tabletail{%
      ...
      \begin{xtabular}[t]{|l|l|l|}\hline
        ...
        Molecular 
formula &
        Boiling point (${}^{\ensuremath{{\,}^{\circ}}}\mathrm{C}$)% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
        Methane &
        ${\mathrm{CH}}_{4}$ &
...
and the gas becomes a liquid (or a solid.)% make-rowspan-placeholders
    ...
    \begin{caption}{\small\bfseries Table 2.4}: Table summarising the general features of solids, liquids and 
\end{table}
gases.\end{center}
    \par
