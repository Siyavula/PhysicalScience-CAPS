         \chapter{Transverse Pulses}\fancyfoot[LO,RE]{Focus Area: Physics}
    \setcounter{figure}{1}
    ...
    \label{m38801*cid2}
            ...
            \nopagebreak
      \label{m38801*id312450}This chapter forms the basis of the discussion into mechanical waves. Waves are all around us. An everyday example of waves are waves in water or the sea. Waves can be created in any container of water. 
...
\begin{minipage}{.5\textwidth}
      \label{m38801*id312816}We will speak about waves moving in a medium. A medium is just the substance or material through which waves move. In other words the medium carries the wave from one place to another. The medium does not create the wave and the medium is not the wave. Therefore the medium does not travel with the wave as the wave propagates through it. Air is a medium for sound waves, water is a medium for water waves and rock is a medium for earthquakes. Air, water and rock are therefore examples of media (media is the plural of medium).\par 
\end{minipage}
\begin{minipage}{.5\textwidth}
\begin{center}
 \includegraphics[width=.8\textwidth]{photos/waveby-mikeyskatie-flickr.jpg}\par
\textit{Picture by mikeyskatie on Flickr.com}
\end{center}
\end{minipage}
...
\subsection{ What is a \textsl{pulse}?}
 ...
 shows an example of a transverse pulse. In the activity, the rope or spring was held horizontally and the pulse moved the rope up and down. This was an example of a transverse pulse.\par
    ...
    \Definition{   \label{id2434846}\textbf{ Pulse }} { \label{m38801*meaningfhsst!!!underscore!!!id71}
      \label{m38801*id312926}A pulse is a single disturbance that moves through a medium. \par 
       } 

    \Definition{   \label{id2434870}\textbf{ Transverse Pulse }} { \label{m38801*meaningfhsst!!!underscore!!!id72}
...
\end{g_experiment}
            ...
            \nopagebreak
\par
           \Definition{   \label{id2435275}\textbf{ Pulse Speed }} { \label{m38801*meaningfhsst!!!underscore!!!id145}
...
\par
    ...
    {% Answer
        ...
        \begin{itemize}[noitemsep]
            \item the distance travelled by the pulse: $D=2\phantom{\rule{2pt}{0ex}}\mathrm{m}$
            \item the time taken to travel $2\phantom{\rule{2pt}{0ex}}\mathrm{m}$: $t=4\phantom{\rule{2pt}{0ex}}\mathrm{s}$
        \end{itemize}
    ...
    \begin{equation}
    \begin{array}{ccc}\hfill v& =& \frac{D}{t}\hfill \\ & =& \frac{2\phantom{\rule{0.166667em}{0ex}}\mathrm{m}}{4\phantom{\rule{0.166667em}{0ex}}\mathrm{s}}\hfill \\ & =& 0,5\phantom{\rule{0.166667em}{0ex}}\mathrm{m}\ensuremath{\cdot}{\mathrm{s}}^{-1}\hfill \end{array}
      \end{equation}}
...
\label{m38802*fs-id1166232432154}
      ...
      \label{m38802*id316148}Constructive interference takes place when two pulses meet each other to create a larger pulse. The amplitude of the resulting pulse is the sum of the amplitudes of the two initial pulses. This is shown in Figure \ref{m38802*uid53!!!underscore!!!media}.\par 

\Definition{   \label{id2436281}\textbf{ Constructive interference}} { \label{m38802*meaningfhsst!!!underscore!!!id567}
...
\Definition{   \label{id2436357}\textbf{ Destructive interference}} { \label{m38802*meaningfhsst!!!underscore!!!id578}
...
\begin{gexperiment}{ Experiment: Constructive and destructive interference}
...
\begin{oecexercises}{ Exercises - Transverse Pulses}
            \nopagebreak
