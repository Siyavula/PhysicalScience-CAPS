    ...
    \label{m38801*cid2}
            ...
            \nopagebreak
      \label{m38801*id312450}This chapter forms the basis of the discussion into mechanical waves. Waves are all around us. An everyday example of waves are waves in water or the sea. Waves can be created in any container of water. We begin by discussing pulses. Pulses are disturbances in a medium.
...
\begin{minipage}{.5\textwidth}
      \label{m38801*id312816}A medium is just the substance or material through which a pulse moves. In other words the medium carries the pulse from one place to another. The medium does not create the pulse and the medium is not the pulse. Therefore the medium does not travel with the pulse as the pulse propagates through it. \par %Air is a medium for sound waves, water is a medium for water waves and rock is a medium for earthquakes. Air, water and rock are therefore examples of media (media is the plural of medium).\par 
...
The principle of superposition states that when two disturbance occupy the same space at the same time they are added.} 
