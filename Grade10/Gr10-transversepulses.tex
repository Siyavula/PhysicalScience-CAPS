...
\par
    ...
    {%Question
        \label{m38801*id313369}A pulse covers a distance of $2\phantom{\rule{3pt}{0ex}}\text{m}$ in $4\phantom{\rule{3pt}{0ex}}\text{s}$ on a heavy rope. Calculate the pulse speed. \par
    }
    {% Answer
        \westep{}{ 
