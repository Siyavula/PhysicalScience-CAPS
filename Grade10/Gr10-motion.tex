...
\end{center}
 \end{figure}       
    ...
    \begin{equation*}
    \begin{array}{ccc}\hfill \Delta \vec{x}& =& \vec{v}_{i}\left(\frac{\vec{v}_{f}-\vec{v}_{i}}{a}\right)+\frac{1}{2}a{\left(\frac{\vec{v}_{f}-\vec{v}_{i}}\vec{a}\right)}^{2}\hfill \\ & =& \frac{\vec{v}_{i}\vec{v}_{f}}\vec{a}-\frac{\vec{v}_{i}^{2}}\vec{a}+\frac{1}{2}\vec{a}\left(\frac{\vec{v}_{f}^{2}-2\vec{v}_{i}\vec{v}_{f}+\vec{v}_{i}^{2}}{\vec{a}^{2}}\right)\hfill \\ & =& \frac{\vec{v}_{i}\vec{v}_{f}}\vec{a}-\frac{\vec\vec{v}_{i}^{2}}\vec{a}+\frac{\vec{v}_{f}^{2}}{2\vec{a}}-\frac{\vec{v}_{i}\vec{v}_{f}}\vec{a}+\frac{\vec{v}_{i}^{2}}{2\vec{a}}\hfill \\ \hfill 2\vec{a}\Delta \vec{x}& =& -2\vec{v}_{i}^{2}+\vec{v}_{f}^{2}+\vec{v}_{i}^{2}\hfill \\ \hfill \vec{v}_{f}^{2}& =& \vec{v}_{i}^{2}+2\vec{a}\Delta \vec{x}\hfill \end{array}
      \end{equation*}
