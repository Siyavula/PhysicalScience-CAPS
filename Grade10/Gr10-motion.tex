...
Quantitiy: Position ($x$) \hspace{2cm} Unit name: metre \hspace{2cm} Unit symbol: m} 
...
Quantity: Displacement ($\Delta \vec{x}$) \hspace{2cm} Unit name: metre \hspace{2cm} Unit symbol: $\text{m}$ }
...
Quantity: Distance (D) \hspace{2cm} Unit name: metre \hspace{2cm} Unit symbol: $\text{m}$}
...
Quantity: average speed ($v_{av}$) \hspace{2cm} Unit name: metre per second \hspace{2cm} Unit symbol: $\text{m}\cdot \text{s}^{-1}$} 
...
Quantity: average velocity ($\vec{v}_{av}$) \hspace{2cm} Unit name: metre per second \hspace{2cm} Unit symbol: $\text{m}\cdot \text{s}^{-1}$} 
...
Quantitity: Average acceleration ($\vec{a}_{av}$) \hspace{2cm} Unit name: metre per second squared \hspace{2cm} Unit symbol: $\text{m} \cdot \text{s}^{-2}$ } 
...
Quantity: Instantaneous velocity ($\vec{v}$) \hspace{2cm} Unit name: metre per second \hspace{2cm} Unit name: $\text{m}\cdot \text{s}^{-1}$} 

\Definition{Instantaneous speed}{Instantaneous speed is the magnitude of instantaneous velocity.\\
Quantity: Instanteneous speed ($v$) \hspace{2cm} Unit name: metre per second \hspace{2cm} Unit symbol: $\text{m}\cdot \text{s}^{-1}$} 
