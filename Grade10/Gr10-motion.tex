...
Quantitiy: Position ($x$) \hspace{1cm} Unit name: metre \hspace{1cm} Unit symbol: m} 
...
Quantitity: Average acceleration ($\vec{a}_{av}$) \hspace{1cm} Unit name: metre per second squared \hspace{1cm} Unit symbol: $\text{m} \cdot \text{s}^{-2}$ } 
...
Quantity: Instanteneous speed ($v$) \hspace{1cm} Unit name: metre per second \hspace{1cm} Unit symbol: $\text{m}\cdot \text{s}^{-1}$} 
