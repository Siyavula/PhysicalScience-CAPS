...
\Tip{The words \textsl{initial} and \textsl{final} will be used very often in Physics. \textsl{Initial} refers to the first situation and \textsl{final} to the last situation.  It will often happen that the final value is smaller than the initial value, such that the difference is negative. This is ok!}
...
\subsubsection*{Illustration of distance and displacment}
