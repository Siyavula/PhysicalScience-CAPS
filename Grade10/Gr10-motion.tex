...
\Tip{The gradient of a position vs. time graph gives the average velocity, the tangent give the instantaneous velocity.}
	\par	
...
\Tip{The gradient of a velocity vs. time graph gives the average acceleration, the tangent give the instantaneous acceleration.}
	\par
...
%Q5
\label{m38796*uid148}\item A ball has a uniform acceleration of 4~m$\ensuremath{\cdot}$s${}^{-2}$. Assume the ball starts from rest. Determine the velocity and displacement at the end of 10~s.\newline
%Q6
\label{m38796*uid149}\item A motorcycle has a uniform acceleration of 4~m$\ensuremath{\cdot}$s${}^{-2}$. Assume the motorcycle has an initial velocity of 20~m$\ensuremath{\cdot}$s${}^{-1}$. Determine the velocity and displacement at the end of 12~s.\newline
%Q7
