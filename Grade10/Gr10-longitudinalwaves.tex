...
%            \label{m38782} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \includegraphics[width=0.75cm]{col11305.imgs/summary_fullmarks.png} &   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{} {(section shortcode: P10046 )} \par 
    ...
    \label{m38782*cid3}
            ...
            \nopagebreak
\par
\Definition{Longitudinal waves } { \label{m38782*meaningfhsst!!!underscore!!!id64}
...
\Definition{Compression} { \label{m38782*meaningfhsst!!!underscore!!!id105}
      A \textbf{compression} is a region in a longitudinal wave where the particles are closest together. 
       } 
\par
\Definition{ Rarefaction } { \label{m38782*meaningfhsst!!!underscore!!!id108}
...
\end{center}
 \end{figure}       
      \label{m38782*uid8}
            ...
            \nopagebreak
\par
 \Definition{ Wavelength } { \label{m38782*meaningfhsst!!!underscore!!!id125}
...
\end{center}
 \end{figure}       
      ...
      \label{m38782*uid10}
            ...
            \nopagebreak
            \par
\Definition{Period } { \label{m38782*meaningfhsst!!!underscore!!!id143}
       The \textbf{period} of a wave is the time taken by the wave to move one wavelength.
         } 
\par
 \Definition{Frequency} { \label{m38782*meaningfhsst!!!underscore!!!id146}
