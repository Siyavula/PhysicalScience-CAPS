...
%             \item $v=\mathsf{speed\; in\; m}\ensuremath{\cdot}\mathsf{s}{}^{-1}$\item $f=\mathsf{frequency\; in\; Hz}$\item $\lambda =\mathsf{wavelength\; in\; m}$\end{itemize}
%         \par 
% \par
...
\begin{eqnarray*}
v&=&f\cdot \lambda\\
&=&(440\;\mathsf{Hz})(0,784~\mathsf{m})\\
&=&345~\mathsf{m}\cdot\mathsf{s}^{-1}
\end{eqnarray*}
...
\label{m38783*id293619}\nopagebreak\noindent{}
    \begin{equation}
    T=\frac{1}{f}\phantom{\rule{3pt}{0ex}}\mathsf{or}\phantom{\rule{3pt}{0ex}}f=\frac{1}{T}\tag{8.8}
      \end{equation}
...
\end{enumerate}
                \label{m38783*uid41}\item A flute produces a musical sound travelling at a speed of $320\phantom{\rule{2pt}{0ex}}\mathsf{m}\ensuremath{\cdot}\mathsf{s}{}^{-1}$. The frequency of the note is 256 Hz. Calculate:
