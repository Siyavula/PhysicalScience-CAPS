...
\item Take a slinky spring and lay it on a table. Hold one end and pull the free end of the spring and release it. Observe what happens.
...
\uput[r](-10,0.7){pull on spring and release}
\end{pspicture}
\end{center}
...
\item Pull the spring back and forth continuously to set up a train of pulses, a longitudinal wave.
\end{enumerate}
\end{minipage}
\begin{minipage}{.5\textwidth}
\begin{center}
 \includegraphics[width=.8\textwidth]{photos/Slinky_Flickr_Tim Ebbs.jpg}
\end{center}
\end{minipage}
\end{activity}
