...
\begin{itemize}
\item \Definition{Periodicity}{Periodicity is the observed trends in element properties with increasing atomic number}
\item \Definition{Atomic radius}{The atomic radius is a measure of the size of an atom.}
\item \Definition{Ionisation energy}{This is the energy needed to remove one electron from an atom of the element}
\item \Definition{Electron affinity}{Electron affinity can be thought of as how much an element wants electrons.}
\item \Definition{Electronegativity}{Electronegativity is the tendency of atoms to attract electrons.}
\end{itemize}
...
\rput(12.5,6.5){\Large{3}}
\rput(13.5,6.5){\Large{4}}
\rput(14.5,6.5){\Large{5}}
\rput(15.5,6.5){\Large{6}}
\rput(16.5,6.5){\Large{7}}
\rput(17.5,7.5){\Large{8}}
...
\begin{table}[H]
 \begin{center}
  \begin{tabular}{|l|l|l|l|l|l|} \hline
   ...
   & \multicolumn{5}{|l|}{Group 1 elements all form halogen compounds in a 1:1 ratio} \\ \hline
...
Atomic radius & \multicolumn{5}{p{8cm}|}{Increases as you move down the group.} \\ \hline
First ionisation energy & \multicolumn{5}{p{8cm}|}{Decreases as you move down the group.} \\ \hline
Electronegativity & \multicolumn{5}{p{8cm}|}{Decreases as you move down the group.} \\ \hline
Melting and boiling point & \multicolumn{5}{p{8cm}|}{Decreases as you move down the group.} \\ \hline
Density & \multicolumn{5}{p{8cm}|}{Increases as you move down the group.} \\ \hline
  \end{tabular}
