...
Electronegativity is the tendency of atoms to attract electrons. The electronegativity of the elements starts from about 0.7 (Francium ($\mathsf{Fr}$)) and goes up to 4 (Fluorine ($\mathsf{F}$))
...
\rput(17.5,7.5){\Large{18}}
 ...
 \end{center}
\end{figure}
We also note that the period number gives the energy level that is being filled. For example, phosphorus ($\mathsf{P}$) is in the third period and group 15. Looking at the figure above, we see that the p-orbital is being filled. Also the third energy level is being filled. So its electron configuration is: $\mathsf{[Ne]}3s^{2}3p^{3}$. (Phosphorus is in the third group in the p-block, so it must have 3 electrons in the p shell.)
      \label{m38760*uid146}
...
\textbf{Element} & $^{23}_{11}\mathsf{Na}$ & $^{24}_{12}\mathsf{Mg}$ &  $^{27}_{13}\mathsf{Al}$ & $^{28}_{14}\mathsf{Si}$ &  $^{31}_{15}\mathsf{P}$ & $^{32}_{16}\mathsf{S}$ & $^{35}_{17}\mathsf{Cl}$ & $^{40}_{18}\mathsf{Ar}$\\ \hline
   \textbf{Compounds with chlorine} & $\mathsf{NaCl}$ & $\mathsf{MgCl}_2$ & $\mathsf{AlCl}_{3}$ & $\mathsf{SiCl}_{4}$ & $\mathsf{PCl}_{5}$ or $\mathsf{PCl}_{3}$ & $\mathsf{S}_{2}\mathsf{Cl}_{2}$ & no chlorides & no compounds \\ \hline
\textbf{Compounds with oxygen} & $\mathsf{Na}_{2}\mathsf{O}$ & $\mathsf{MgO}$ & $\mathsf{Al}_{2}\mathsf{O}_{3}$ & $\mathsf{SiO}_{2}$ & $\mathsf{P}_{4}\mathsf{O}_{6}$ or $\mathsf{P}_{4}\mathsf{O}_{10}$ & $\mathsf{SO}_{3}$ or $\mathsf{SO}_{4}$ & $\mathsf{Cl}_{2}\mathsf{O}_{7}$ or $\mathsf{Cl}_{2}\mathsf{O}$ & no compounds \\ \hline
...
\label{fig:atom:periodic1}
 \end{figure} 
From this we see that that the radius of the atoms increases down a group. The ionisation energy and the electronegativity both decrease down a group. The melting and boiling points also decrease down a group, while the density increases. \\
...
\textbf{Element} & $^{7}_{3}\mathsf{Li}$ & $^{7}_{3}\mathsf{Na}$ &  $^{7}_{3}\mathsf{K}$ & $^{7}_{3}\mathsf{Rb}$ &  $^{7}_{3}\mathsf{Cs}$ \\ \hline
\textbf{Electron structure} & $\textsf{[He]}2s^{1}$ & $\textsf{[Ne]}3s^{1}$ & $\textsf{[Ar]}4s^{1}$ & $\textsf{[Kr]}4s^{1}$ & $\textsf{[Xe]}5s^{1}$ \\ \hline
   \multirow{2}{*}{\textbf{Group 1 chlorides}} & $\mathsf{LiCl}$ & $\mathsf{NaCl}$ & $\mathsf{KCl}$ & $\mathsf{RbCl}$ & $\mathsf{CsCl}$ \\ \cline{2-6}
   & \multicolumn{5}{|p{6cm}|}{Group 1 elements all form halogen compounds in a 1:1 ratio} \\ \hline
\multirow{2}{*}{\textbf{Group 1 oxides}} & $\mathsf{Li}_{2}\mathsf{O}}$ & $\mathsf{Na}_{2}\mathsf{O}}$ & $\mathsf{K}_{2}\mathsf{O}}$ & $\mathsf{Rb}_{2}\mathsf{O}}$ & $\mathsf{Cs}_{2}\mathsf{O}}$\\ \cline{2-6}
...
\end{table}
\par 
We can use the above information to predict the chemical properties of unfamiliar elements. For example, given the element Francium ($\mathsf{Fr}$) we can say that it's electronic structure will be $\textsf{[Rn]}7s^{1}$, it will have a lower first ionisation energy than caesium ($\mathsf{Cs}$) and it's melting and boiling point will also be lower than caesium. \\
...
\item Give one word or term for each of the following:
   ...
   \end{enumerate}
\item Given $^{80}_{35}\mathsf{Br}$ and $^{80}_{35}\mathsf{Cl}$. Compare these elements in terms of the following properties. Explain the differences in each case.
  \begin{enumerate}[noitemsep, label=\textbf{\alph*}. ]
   \item Atomic radius
   \item Electronegativity
   \item First ionisation energy
...
6.5 1.297
7.5 1.576}
\rput{0}(0.5,-0.2){$\mathsf{Na}$}
\rput{0}(1.5,-0.2){$\mathsf{Mg}$}
\rput{0}(2.5,-0.2){$\mathsf{Al}$}
\rput{0}(3.5,-0.2){$\mathsf{Si}$}
\rput{0}(4.5,-0.2){$\mathsf{P}$}
\rput{0}(5.5,-0.2){$\mathsf{S}$}
\rput{0}(6.5,-0.2){$\mathsf{Cl}$}
\rput{0}(7.5,-0.2){$\mathsf{Ar}$}
\end{pspicture}
  \begin{enumerate}[noitemsep, label=\textbf{\alph*}. ]
