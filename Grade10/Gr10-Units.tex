...
For example, Jack and Jill walk to school. They walk 0,9 kilometers to get to school and it takes them 17 minutes. We can calculate their speed in the following two ways.\par 
    ...
    \begin{equation}
    \begin{array}{ccc}\hfill \mathrm{time}\mathrm{in}\mathrm{hours}& =& \frac{17\mathrm{min}}{60\mathrm{min}}\hfill \\ & =& 0,283333333\mathrm{hr}\hfill \end{array}
      \end{equation}
\label{m30853*id64327}\nopagebreak\noindent{}
            
    \begin{equation}
    \begin{array}{ccc}\hfill \mathrm{speed}& =& \frac{\mathrm{Distance}}{\mathrm{Time}}\hfill \\ & =& \frac{0,9\mathrm{km}}{0,28333333\mathrm{hr}}\hfill \\ & =& 3,176470588k\ensuremath{\cdot}{h}^{-1}\hfill \\ & =& 3,18k\ensuremath{\cdot}{h}^{-1}\hfill \end{array}
      \end{equation}
          \textbf{Method 2:}
...
\westep{Write the answer}3 800~mm $÷$ 1000 = 3,8~$\mathrm{m}$ 
    }
\end{wex}
    \noindent
\par
