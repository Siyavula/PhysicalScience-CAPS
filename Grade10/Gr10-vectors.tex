...
\section{Properties of vectors}
    \nopagebreak
%            \label{m38813} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11305.imgs/summary_www.png}} {(section shortcode: P10092 )} 
    \label{m38813*cid7}
...
=======
>>>>>>> 727497e3184f7943c0e0041b12139e4aff4dbbd0
\end{exercises}
