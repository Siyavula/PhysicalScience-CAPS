...
Quantity: Potential difference (V) \hspace{2cm} Unit name: volt\hspace{2cm} Unit symbol: $V$}
...
Quantity: Current (I) \hspace{2cm} Unit name: ampere\hspace{2cm} Unit symbol: A}
...
\includegraphics[width=.8\textwidth]{photos/ammeter.jpg}\\
...
Quantity: Resistance $R$\hspace{2cm} Unit: ohm \hspace{2cm} Unit symbol: $\omega$\\
}
\begin{equation*}
