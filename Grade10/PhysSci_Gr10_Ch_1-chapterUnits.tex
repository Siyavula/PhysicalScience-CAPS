...
these letters.\par 
    ...
    \begin{caption}{\small\bfseries Table 1}: SI Base Units\end{caption}
\end{table}
    \par
      \label{m30853*uid3}
...
\textbf{j}oule (J).\par 
    ...
    \begin{caption}{\small\bfseries Table 2}: Some examples of combinations of SI base units assigned
\end{table}
...
\label{m30853*secfhsst!!!underscore!!!id320}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 1:  Rounding-off }
        ...
        \label{m30853*id63850}Round off $\pi =3,141592654...$ to 4 decimal places. \par 
        \vspace{5pt}
        ...
        \par 
        \item  
        \label{m30853*id63934}The last digit of $\pi =3,1415|92654...$ must be rounded up because there is a 9 after the $|$.\par 
        \item  
        \label{m30853*id63977}$\pi =3,1416$ rounded to 4 decimal places. \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
    }
...
\label{m30853*secfhsst!!!underscore!!!id346}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 2:  Rounding-off }
        ...
        \label{m30853*id64022}Round off $9,191919...$ to 2 decimal places \par 
        \vspace{5pt}
        ...
        \par 
        \item  
        \label{m30853*id64098}The last digit of $9,19|1919...$ must be rounded down because there is a 1 after the~$|$.\par 
        \item  
...
The kilogram is unique in that it is the only SI base unit containing a prefix.\par 
    ...
    \begin{caption}{\small\bfseries Table 3}: Unit Prefixes\end{caption}
\end{table}
    \par
...
\par
    ...
    \noindent\textbf{Exercise 3:  Conversion 1 }
      ...
      \item  
      \label{m30853*id67126}3 800~mm $÷$ 1000 = 3,8~$\mathrm{m}$ \par 
      \end{enumerate}
    \end{exercise}
    \end{mdframed}
    }
...
\par
    ...
    \noindent\textbf{Exercise 4:  Conversion 2 }
      ...
      \item  
      \label{m30853*id67222}4,56 kg $\ensuremath{\times}$ 1000 = 4560~$\mathrm{g}$ \par 
      \end{enumerate}
    \end{exercise}
    \end{mdframed}
    }
...
When converting km$\ensuremath{\cdot}$h${}^{-1}$ to m$\ensuremath{\cdot}$s${}^{-1}$you divide by 3,6. For example 72 km$\ensuremath{\cdot}$h${}^{-1}$$÷$~3,6 = 20 m$\ensuremath{\cdot}$s${}^{-1}$.\par 
