...
\end{figure}       
    ...
    \textnormal{Phet simulation for Transverse Waves} \nopagebreak
...
\Definition{Amplitude } { \label{m38801*meaningfhsst!!!underscore!!!id77}
...
\Definition{Frequency } { \label{m38806*meaningfhsst!!!underscore!!!id430}
...
\end{wex}
    ...
    \noindent
      \label{m38806*uid21}
            ...
            \nopagebreak
       \Definition{Wave speed }{Wave speed is the distance a wave travels per unit time. \par 
...
\label{m38806*eip-872}The following video provides a summary of the concepts covered so far.
    ...
    \textnormal{Khan academy video on waves - 1} \nopagebreak
