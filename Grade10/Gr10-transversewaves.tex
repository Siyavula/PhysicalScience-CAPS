...
\IFact{
A tsunami is a series of sea waves caused by an underwater earthquake, landslide, or volcanic eruption. When the ocean is deep, tsunamis may be less than a 30~cm high on the ocean’s surface and can travel at speeds up to 700~$\mathsf{km}\cdot \mathsf{hr}^{-1}$.
...
{%question
    \label{m38806*id318469}If the crest of a wave measures $2\phantom{\rule{2pt}{0ex}}\mathsf{m}$ above the still water mark in the harbour, what is the amplitude of the wave? \par 
}
{%solution
\westep{}{  
        \label{m38806*id318492}The definition of the amplitude is the height of a crest above the equilibrium position. The still water mark is the height of the water at equilibrium and the crest is $2\phantom{\rule{2pt}{0ex}}\mathsf{m}$ above this, so the amplitude is $2\phantom{\rule{2pt}{0ex}}\mathsf{m}$. \par 
}}
\end{wex}
