...
\par
\Definition{   \label{id2439255}\textbf{ Peaks and troughs }} { \label{m38806*meaningfhsst!!!underscore!!!id136}
...
\Definition{   \label{id2440606}\textbf{ Period ($\mathrm{T}$) }} { \label{m38806*meaningfhsst!!!underscore!!!id426}The period ($\mathrm{T}$) is the time taken for two successive peaks (or troughs) to pass a fixed point.
         } 
