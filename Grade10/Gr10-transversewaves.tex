...
\IFact{
A tsunami is a series of sea waves caused by an underwater earthquake, landslide, or volcanic eruption. When the ocean is deep, tsunamis may be less than a 30~cm high on the ocean'sÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂs surface and can travel at speeds up to 700~$\text{km}\cdot \text{hr}^{-1}$.
