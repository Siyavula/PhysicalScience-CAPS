...
\mindset{Transverse waves}{VPckg}
...
\label{m38806*fhsst!!!underscore!!!id83}\begin{definition}
	  \Definition{Wave } { \label{m38806*meaningfhsst!!!underscore!!!id83}
      \label{m38806*id317713}A \textsl{wave} is a periodic, continuous disturbance that consists of a \textsl{train} of pulses.} 
\Definition{Transverse wave } { \label{m38806*meaningfhsst!!!underscore!!!id86}
...
\end{activity}
      ...
      \label{m38806*id317884}As we have seen in the activity we can create waves. The medium through which these waves propagated was the rope, which is obviously made up of a very large number of particles (atoms).
...
\Definition{Amplitude} {The amplitude of a wave is a measurement of how far the medium is displaced from equilibrium (rest).\\
...
\IFact{
A tsunami is a series of sea waves caused by an underwater earthquake, landslide, or volcanic eruption. When the ocean is deep, tsunamis may be less than a 30~cm high on the ocean'sÂÂs surface and can travel at speeds up to 700~$\text{km}\cdot \text{hr}^{-1}$.
...
\end{center}
 ...
 \end{figure}       
      ...
      \label{m38806*uid20}
            ...
            \nopagebreak
        \label{m38806*id319195}Imagine you are sitting next to a pond that has waves created by the wind and you watch the waves going past you. First one crest arrives, then a trough, and then another crest. Suppose you measure the time taken between one crest arriving and then the next. This time will be the same for any two successive crests passing you. We call this
time the \textsl{period}, and it is a characteristic of the wave.
\mindsetvid{Period and frequency}{VPctl}
...
The frequency and the period are related to each other. As the period is the time taken for 1 crest to pass, then the number of crests passing the point in 1 second is $\frac{1}{T}$. But this is the frequency. So we can use\\
\begin{minipage}{.3\textwidth}
\begin{equation*}
\boxed{f=\frac{1}{T}}
\end{equation*}
\end{minipage}
\begin{minipage}{.3\textwidth}\begin{center}
or \end{center}
\end{minipage}
\begin{minipage}{.3\textwidth}
\begin{equation*}
...
\end{wex}
   ...
   \mindsetvid{Calculating the speed of a transverse wave}{VPdan}
        \label{m38806*id319706}The distance between two successive crests is 1 wavelength, $\lambda $. Thus in a time of 1 period, the wave will travel 1 wavelength in distance. Thus the speed of the wave, $v$, is:
    \begin{equation*}
