...
\IFact{Scientists believe that the electron can be treated as a \textbf{point particle} or \textbf{elementary particle} meaning that it can't be broken down into anything smaller.} The electron carries one unit of \textbf{negative} electric charge.\par
      \label{m38745*uid11}
...
The number of neutrons is simply the difference $N=A-Z=30$.\par 
