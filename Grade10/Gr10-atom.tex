...
\end{figure}
\end{minipage}
\Tip{The spectroscopic electron configuration can be written in shorter form. For example, magnesium can be represented as $\mathrm{[Ne]}3s^{2}$ and carbon as $\mathrm{[H]}2s^{2}2p^{2}$}
\begin{wex}
{%title
Aufbau diagrams and spectroscopic electron configuration 
}
{%question
Give the electron configuration for nitrogen ($\mathrm{N}$) and draw an aufbau diagram.
}
{%answer
\westep{Give the number of electrons} Nitrogen has 7 electrons.
...
\end{figure}
Now we have 5 electrons left to place in orbitals.  
...
\end{figure}    
There are now 3 electrons to place in orbitals.
\westep{Place three electrons in the $2p$ orbital}
We place 3 electrons in the $2p$ orbital: ${2p}^{3}$.
\begin{figure}[H]
\scalebox{.7}{
 \begin{pspicture}(-8,-8)(8,5)
%\psgrid
...
\westep{Write the final answer} The electron configuration is: ${1s}^{2}{2s}^{2}{2p}^{3}$. The Aufbau diagram is given in the step above.
