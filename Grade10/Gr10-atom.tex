...
\IFact{Scientists believe that the electron can be treated as a \textbf{point particle} or \textbf{elementary particle} meaning that it cannot be broken down into anything smaller.} The electron carries one unit of \textbf{negative} electric charge (i.e. $-1,6 \times {10}^{-19} \text{ C}$).
      \label{m38745*uid11}
