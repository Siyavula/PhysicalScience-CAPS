...
\simulation{Phet simulation for Isotopes}{VPcyv}
...
\begin{i_experiment}{Flame tests}{
            \nopagebreak
            \label{m38741*eip-699}\noindent{}\textbf{Aim: } To determine what co lour a metal cation will cause a flame to be. \\
...
\label{m38741*eip-6993}\noindent{}\textbf{Results: } Record your results in a table, listing the metal salt and the co lour of the flame.
\\ 
\label{m38741*eip-6994}\noindent{}\textbf{Conclusion: } You should have observed different co lours for each of the metal salts and powders that you tested.}
\end{i_experiment}
...
\end{enumerate}
 ...
 \practiceinfo
 \begin{tabular}[h]{cccccc}
 (1.) lif  &  (2.) lbu  &  (3.) li7  &  (4.) liA  &  (5.) lio  &  (6.) lbJ  &  (7.) lbS  &  (8.) lg7  &  (9.) lgG  &  (10.) lbh  &  (11.) ljl  &  (12.) lji  &  (13.) l4j  &  (14.) lj3  &  & &  & \end{tabular}
