...
\par \label{m38756*cid2}
      ...
      \label{m38756*id254508}The idea of atoms was invented by two Greek philosophers, Democritus and Leucippus in the fifth century BC. The Greek word $\text{\alpha \tau o\mu o\nu }$ \hspace{1ex} (atom) means \textbf{indivisible} because they believed that atoms could not be broken into smaller pieces.\par 
...
element symbol $\text{C}$ (see the Table of Elements). Atoms which have the same number of protons, but a different number of neutrons, are called \textbf{isotopes}.\par 
...
isotopes of an element are the same, but they might vary in how stable their nucleus is. Note that we can also write elements as $\text{X\; -\; A}$ where the X is the element symbol and the A is the atomic mass of that element. For example $\text{Cl-}35$ has an atomic mass of $35 u$ (17 protons and 18 neutrons), while $\text{Cl-}37$ has an atomic mass of $37 u$ (17 protons and 20 neutrons).\par 
...
\end{enumerate}
                \label{m38753*uid64}\item Which of the following are isotopes of $\text{U-}235$? (X represents an element symbol)
...
Aufbau diagrams for the elements fluorine and argon are shown in figures \ref{fig:Aufbau:fluorine} and \ref{fig:Aufbau:argon} respectively. Using standard notation, the electron configuration of fluorine is $1\text{s}^{2}{2}\text{s}^{2}2\text{p}^{5}$ and the electron configuration of argon is $1\text{s}^{2}{2}\text{s}^{2}2\text{p}^{5}{3}\text{s}^{2}3\text{p}^{6}$. \\
\begin{minipage}{.5\textwidth}
\begin{figure}[H]
\begin{center}
\scalebox{0.7}{
...
We place 3 electrons in the $2\text{p}$ orbital: ${2\text{p}}^{3}$.
\begin{figure}[H]
\scalebox{.7}{
 \begin{pspicture}(-8,-8)(8,5)
%\psgrid
...
We place 6 electrons in the $2\text{p}$ orbital: ${2\text{p}}^{6}$.
\westep{Write the final answer} The electron configuration is: ${1\text{s}}^{2}{2\text{s}}^{2}{2\text{p}}^{6}$. The Aufbau diagram will look as follows:
\begin{figure}[H]
\scalebox{.7}{
 \begin{pspicture}(-8,-8)(8,5)
%\psgrid
