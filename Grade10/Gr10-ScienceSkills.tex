...
Watch glass & \includegraphics[width=.2\textwidth]{photos/watchglass.jpg} & \\ \hline
Mass meter & & \\ \hline
Thermometer & \includegraphics[width=.2\textwidth]{photos/thermometer.jpg} & \\ \hline
Funnel & \includegraphics[width=.1\textwidth]{photos/funnel.jpg} & \\ \hline
  \end{tabular} 
 \end{center}
\end{table}
