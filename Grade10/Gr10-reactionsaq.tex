...
\end{figure}     
        ...
        \label{m38720*uid3241}$\mathsf{NaCl (s)} \to {\mathsf{Na}}^{+}\mathsf{(aq)} + {\mathsf{Cl}}^{-}\mathsf{(aq)}$
        \par 
        ...
        \label{m38720*uid971321}${\mathsf{K}}_{2}{\mathsf{SO}}_{4}\mathsf{(s)}\to 2{\mathsf{K}}^{+}\mathsf{(aq)}+\mathsf{SO}_{4}^{2-}\mathsf{(aq)}$
        \par 
        ...
        \label{m38720*uid922381}${\mathsf{C}}_{6}{\mathsf{H}}_{12}{\mathsf{O}}_{6}\mathsf{(s)}\rightarrow{\mathsf{C}}_{6}{\mathsf{H}}_{12}{\mathsf{O}}_{6}\mathsf{(aq)}$
        \par 
        ...
        \label{m38720*uid98732}$\mathsf{HCl (g)} + \mathsf{H}_{2}\mathsf{O (\ell)} \to \mathsf{H}_{3}\mathsf{O}^{+} \mathsf{(aq)} + {\mathsf{Cl}}^{-}\mathsf{(aq)}$
        \par 
    \noindent
...
\label{m38720*id336110}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38720*uid23}\item potassium nitrate ($\mathsf{KNO}_{3}$)
\label{m38720*uid24}\item ethanol ($\mathsf{C}_{2}\mathsf{H}_{5}\mathsf{OH}$)
\label{m38720*uid25}\item sucrose (a type of sugar) ($\mathsf{C}_{12}\mathsf{H}_{22}\mathsf{O}_{11}$)
\label{m38720*uid26}\item sodium bromide ($\mathsf{NaBr}$)
\end{enumerate}
...
\label{m38720*id336252}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38720*uid28}\item sodium sulphate ($\mathsf{Na}_{2}\mathsf{SO}_{4}$)
\label{m38720*uid29}\item potassium bromide ($\mathsf{KBr}$)
\label{m38720*uid30}\item potassium permanganate ($\mathsf{KMnO}_{4}$)
\label{m38720*uid31}\item sodium phosphate ($\mathsf{Na}_{3}\mathsf{PO}_{4}$)
\end{enumerate}
\item Draw a diagram to show how $\mathsf{KCl}$ dissolves in water.
\end{enumerate}
      \label{m38720*uid32}
...
% \textbf{Hard water} is water that has a high mineral content. Water that has a low mineral content is known as \textbf{soft water}. If water has a high mineral content, it usually contains high levels of metal ions, mainly calcium ($\mathsf{Ca}^{2+}$) and magnesium ($\mathsf{Mg}^{2+}$). The calcium ions enter the water from either ${\mathsf{CaCO}}_{3}$ (limestone or chalk) or from mineral deposits of ${\mathsf{CaSO}}_{4}$. The main source of magnesium is a sedimentary rock called dolomite, ${\mathsf{CaMg(CO}}_{3}\mathsf{)}_{2}$. Hard water may also contain other metals as well as bicarbonates and sulphates.\par 
...
% \end{minipage}
% \begin{minipage}{.5\textwidth}
% The acidity of rainwater comes from the natural presence of three substances ($\mathsf{CO}_{2}$, $\mathsf{NO}$, and $\mathsf{SO}_{2}$) in the lowest layer of the atmosphere. These gases are able to dissolve in water and therefore make rain more acidic than it would otherwise be. Of these gases, carbon dioxide ($\mathsf{CO}_{2}$) has the highest concentration and therefore contributes the most to the natural acidity of rainwater. \par 
...
% \label{m38720*id338337}Acid rain can also affect buildings and monuments, many of which are made from marble and limestone. A chemical reaction takes place between ${\mathsf{CaCO}}_{3}$ (limestone) and sulphuric acid to produce aqueous ions which can be easily washed away. The same reaction can occur in the lithosphere where limestone rocks are present e.g. limestone caves can be eroded by acidic rainwater.
%         \label{m38720*id7435}\nopagebreak\noindent{}       
%     \begin{equation}
%     {\mathsf{H}}_{2}{\mathsf{SO}}_{4}+{\mathsf{CaCO}}_{3}\to {\mathsf{CaSO}}_{4}\ensuremath{\cdot}\mathsf{H}{}_{2}\mathsf{O}+{\mathsf{CO}}_{2}\tag{17.2}
%       \end{equation}
% \end{minipage}
% \end{activity}
    \label{m38720*cid7}
...
A strong electrolyte is one where many ions are present in the solution and a weak electrolyte is one where few ions are present. Strong electrolytes are good conductors of electricity and weak electrolytes are weak conductors of electricity. Non-electrolytes do not conuct electricity at all. 
...
\label{m38720*uid57}\item The \textbf{type of substance} that dissolves in water. Whether a material is a strong electrolyte (e.g. potassium nitrate, ${\mathsf{KNO}}_{3}$), a weak electrolyte (e.g. acetic acid, ${\mathsf{CH}}_{3}\mathsf{COOH}$) or a non-electrolyte (e.g. sugar, alcohol, oil) will affect the conductivity of water because the concentration of ions in solution will be different in each case. Strong electrolytes form ions easily, weak electrolytes do not form ions easily and non-electrolytes do not form ions in solution.
...
\item Solid salt ($\mathsf{NaCl}$) crystals
\item different liquids such as distilled water, tap water, seawater, sugar, oil and alcohol
\item solutions of salts e.g. $\mathsf{NaCl}$, $\mathsf{KBr}$, $\mathsf{CaCl}_{2}$, $\mathsf{NH}_{4}\mathsf{Cl}$
\item a solution of an acid (e.g. $\mathsf{HCl}$) and a solution of a base (e.g. $\mathsf{NaOH}$)
\item torch cells
\item ammeter
...
Dissociation of potassium bromide:
    ...
    \begin{equation*}
    \mathsf{KBr (s)} \to {\mathsf{K}}^{+} \mathsf{(aq)} + {\mathsf{Br}}^{-} \mathsf{(aq)}
      \end{equation*} \\
Dissociation of table salt:\\
        \label{m38720*id339737}\nopagebreak\noindent          
    \begin{equation*}
    \mathsf{NaCl (s)}\to {\mathsf{Na}}^{+} \mathsf{(aq)} + {\mathsf{Cl}}^{-} \mathsf{(aq)}
      \end{equation*}\\
Ionisation of hydrochloric acid:\\
        \label{m38720*id339770}\nopagebreak\noindent          
    \begin{equation*}
    \mathsf{HCl (\ell)}  +{\mathsf{H}}_{2}\mathsf{O (\ell)} \to {\mathsf{H}}_{3}{\mathsf{O}}^{+} \mathsf{(aq)} +{\mathsf{Cl}}^{-} \mathsf{(aq)}
      \end{equation*}\\
        \label{m38720*id339831}\nopagebreak\noindent
Dissociation of sodium hydroxide:\\          
    \begin{equation*}
    \mathsf{NaOH (s)} \to {\mathsf{Na}}^{+} \mathsf{(aq)} + {\mathsf{OH}}^{-} \mathsf{(aq)}
      \end{equation*}
 \par 
\label{m38720**end}
    ...
    \begin{equation*}
    \mathsf{AB\left(aq\right)}+\mathsf{CD\left(aq\right)}\to \mathsf{AD}+\mathsf{CB}
      \end{equation*}
	  Either $\mathsf{AD}$ or $\mathsf{CB}$ may be a solid or a gas. When a solid forms this is known as a precipitation reaction. If a gas is formed then this may be called a gas forming reaction. Acid-base reactions are a special class of ion exchange reactions and we will look at them seperately. 
      \par 
...
\end{figure}       
      ...
      \label{m38719*id339992}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m38719*uid60}\item Prepare 2 test tubes with approximately $5~\mathsf{ml}$ of dilute copper(II) chloride solution in each
\label{m38719*uid61}\item Prepare 1 test tube with $5~\mathsf{ml}$ sodium carbonate solution
\label{m38719*uid62}\item Prepare 1 test tube with $5~\mathsf{ml}$ sodium sulphate solution
...
For \textbf{reaction 1} you have the following ions in your solution: ${\mathsf{Cu}}^{2+}$, ${\mathsf{Cl}}^{-}$, ${\mathsf{Na}}^{+}$ and $\mathsf{CO}_{3}^{2-}$. A precipitate will form if any combination of cations and anions can become a solid. the following table summarises which combination will form solids (precipitates) in solution. 
          \begin{table}[H]
    % \begin{table}[H]
    % \\ '' '0'
        \begin{center}
...
If you look under carbonates in the table it states that all carbonates are \textbf{insoluble} except potassium sodium and ammonium. This means that $\mathsf{Na}_{2}\mathsf{CO}_3$ will dissolve in water or remain in solution, but $\mathsf{CuCO}_3$ will form a precipitate. The precipitate that was observed in the reaction must therefore be $\mathsf{CuCO}_3$. The balanced chemical equation is:\\
$2\mathsf{Na}^{+} \mathsf{(aq)} + \mathsf{CO}_{3}^{2-} \mathsf{(aq)} + \mathsf{Cu}^{2+} \mathsf{(aq)} + 2\mathsf{Cl}^{-} \mathsf{(aq)} \to \mathsf{CuCO}_{3} \mathsf{(s)} +  2\mathsf{Na}^{+} \mathsf{(aq)} + 2\mathsf{Cl}^{-} \mathsf{(aq)}$ \\
Note that sodium chloride does not precipitate and we write it as ions in the equation.
For \textbf{reaction 2} we have ${\mathsf{Cu}}^{2+}$, ${\mathsf{Cl}}^{-}$, ${\mathsf{Na}}^{+}$ and $\mathsf{SO}_{4}^{2-}$ in solution. Most chlorides and sulphates are soluble according to the table. The balanced chemical equation is: \\
$2{\mathsf{Na}}^{+} \mathsf{(aq)} + \mathsf{SO}_{4}^{2-} \mathsf{(aq)} + {\mathsf{Cu}}^{2+} \mathsf{(aq)} + 2{\mathsf{Cl}}^{-} \mathsf{(aq)} \to 2{\mathsf{Na}}^{+} \mathsf{(aq)} + \mathsf{SO}_{4}^{2-} \mathsf{(aq)} + {\mathsf{Cu}}^{2+} \mathsf{(aq)} + 2{\mathsf{Cl}}^{-} \mathsf{(aq)} $
...
% \Warning{As always when working with chemicals, you must work carefully as you can easily get bad chemical burns if you spill the chemicals on yourself.}
    ...
    \begin{equation*}
    {\mathsf{Cl}}^{-} \mathsf{(aq)} +{\mathsf{Ag}}^{+} \mathsf{(aq)} + \mathsf{NO}_{3}^{-} \mathsf{(aq)} \to \mathsf{AgCl} \mathsf{(s)} +\mathsf{NO}_{3}^{-} \mathsf{(aq)}
      \end{equation*}
     ($\mathsf{AgCl}$ is white precipitate)
        \label{m38719*id341211}\nopagebreak\noindent{}
    \begin{equation*}
    \mathsf{CO}_{3}^{2-} \mathsf{(aq)} + 2{\mathsf{Ag}}^{+} \mathsf{(aq)} + 2\mathsf{NO}_{3}^{-} \mathsf{(aq)} \to {\mathsf{Ag}}_{2}{\mathsf{CO}}_{3} \mathsf{(s)} + 2\mathsf{NO}_{3}^{-} \mathsf{(aq)}
      \end{equation*}
    (${\mathsf{Ag}}_{2}{\mathsf{CO}}_{3}$ is white precipitate)\par 
        ...
        \label{m38719*id341334}$\mathsf{AgCl} \mathsf{(s)} + {\mathsf{HNO}}_{3} \mathsf{(\ell)} \to $ (no reaction; precipitate is unchanged)\par 
        \label{m38719*id341361}${\mathsf{Ag}}_{2}{\mathsf{CO}}_{3} \mathsf{(s)} + 2{\mathsf{HNO}}_{3} \mathsf{(\ell)} \to 2{\mathsf{Ag}^{+} \mathsf{(aq)} + 2\mathsf{NO}_{3}^{-} \mathsf{(aq)} + {\mathsf{H}}_{2}\mathsf{O} \mathsf{(\ell)} + {\mathsf{CO}}_{2} \mathsf{(g)} $ (precipitate disappears)\par 
            \subsubsection*{Test for bromides and iodides}
            \nopagebreak
        \label{m38719*id341894}As was the case with the chlorides, the bromides and iodides also form precipitates when they are reacted with silver nitrate. Silver chloride is a white precipitate, but the silver bromide and silver iodide precipitates are both pale yellow. To determine whether the precipitate is a bromide or an iodide, we use chlorine water and carbon tetrachloride (${\mathsf{CCl}}_{4}$).\par 
...
$\mathsf{Br}^{-} \mathsf{(aq)} + \mathsf{Cl}_{2} \mathsf{(aq)} \to 2 \mathsf{Cl}^{-} \mathsf{(aq)} + \mathsf{Br}_{2} \mathsf{(g)}$
\par 
        \label{m38719*id341920}Chlorine water frees iodine gas from an iodide and colours the carbon tetrachloride purple.\\
$\mathsf{I}^{-} \mathsf{(aq)} + \mathsf{Cl}_{2} \mathsf{(aq)} \to 2 \mathsf{Cl}^{-} \mathsf{(aq)} + \mathsf{I}_{2} \mathsf{(g)}$
\par 
      \label{m38719*uid71}
        ...
        \label{m38719*id341454}$\mathsf{SO}_{4}^{2-} \mathsf{(aq)} + {\mathsf{Ba}}^{2+} \mathsf{(aq)} + {\mathsf{Cl}}^{-} \mathsf{(aq)} \to {\mathsf{BaSO}}_{4} \mathsf{(s)} + {\mathsf{Cl}}^{-} \mathsf{(aq)} $ (${\mathsf{BaSO}}_{4}$ is a white precipitate)\par 
        \label{m38719*id341538}$\mathsf{CO}_{3}^{2-} \mathsf{(aq)} + {\mathsf{Ba}}^{2+} \mathsf{(aq)} + {\mathsf{Cl}}^{-} \mathsf{(aq)} \to {\mathsf{BaCO}}_{3} \mathsf{(s)} + {\mathsf{Cl}}^{-} \mathsf{(aq)} $ (${\mathsf{BaCO}}_{3}$ is a white precipitate)\par 
        ...
        \label{m38719*id341627}${\mathsf{BaSO}}_{4} \mathsf{(s)} + {\mathsf{HNO}}_{3} \mathsf{(\ell)} \to $ (no reaction; precipitate is unchanged)\par 
        \label{m38719*id341658}${\mathsf{BaCO}}_{3} \mathsf{(s)} + 2{\mathsf{HNO}}_{3} \mathsf{(\ell)} \to \mathsf{Ba}^{2+} \mathsf{(aq)} + 2\mathsf{NO}_{3}^{-} \mathsf{(aq)} + {\mathsf{H}}_{2}\mathsf{O} \mathsf{(\ell)} + {\mathsf{CO}}_{2} \mathsf{(g)} $ (precipitate disappears)\par 
      \label{m38719*uid72}
        ...
        \label{m38719*id341754}$\mathsf{Acid} + \mathsf{CO}_{3}^{2-} \mathsf{(aq)} \to {\mathsf{CO}}_{2} \mathsf{(g)} $\par 
        ...
        \label{m38719*id341800}${\mathsf{Ca}^{2+} \mathsf{(aq)} + 2\mathsf{OH}^{-} \mathsf{(aq)} + {\mathsf{CO}}_{2} \mathsf{(g)} \to {\mathsf{CaCO}}_{3} \mathsf{(s)} + \mathsf{H}_{2}\mathsf{O} \mathsf{(\ell)} $ (It is the insoluble ${\mathsf{CaCO}}_{3}$ precipitate that makes the limewater go milky)\par 
      \label{m38719*uid73}
...
\label{m38719*secfhsst!!!underscore!!!id1016}
            ...
            \label{m38719*uid74}\item Silver nitrate (${\mathsf{AgNO}}_{3}$) reacts with potassium chloride ($\mathsf{KCl}$) and a white precipitate is formed.
...
\label{m38719*id342078}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38719*uid83}\item $\mathsf{NaI}$
\label{m38719*uid84}\item $\mathsf{KCl}$
\label{m38719*uid85}\item ${\mathsf{K}}_{2}{\mathsf{CO}}_{3}$\label{m38719*uid86}\item ${\mathsf{Na}}_{2}{\mathsf{SO}}_{4}$\end{enumerate}
(IEB Paper 2, 2005)\newline
\end{enumerate}
...
\end{exercises}
            \subsection{Other reactions in aqueous solutions}
            \nopagebreak
...
\label{m38719*id0821354}Acid-base reactions take place between acids and bases. In general, the products will be water and a salt (i.e. an ionic compound). An example of this type of reaction is: \label{m38719*eid1534}\nopagebreak\noindent{}
    ...
    \begin{equation*}
    \mathsf{NaOH (aq)}+\mathsf{HCl (aq)}\to \mathsf{NaCl (aq)}+{\mathsf{H}}_{2}\mathsf{O (\ell)}
      \end{equation*}
...
\label{m38719*id624}\nopagebreak\noindent{}
    \begin{equation*}
    4\mathsf{Na}+{\mathsf{O}}_{2}\to 2{Na}_{2}{\mathsf{O}}
      \end{equation*}
...
You will need a bunsen burner, a small piece of sodium metal and a metal spatula. Light the bunsen burner. Place the sodium metal on the spatula. Place the sodium in the flame. When the reaction finishes, you should observe a white powder on the spatula. This is a mixture of sodium oxide (${\mathsf{Na}}_{2}\mathsf{O}$) and sodium peroxide (${\mathsf{Na}}_{2}{\mathsf{O}}_{2}$). 
...
\label{m38719*eip-1901}\noindent{}\textbf{Apparatus: }\newline
    Soluble salts (e.g. potassium nitrate, ammonium chloride, sodium carbonate, silver nitrate, sodium bromide); hydrochloric acid ($\mathsf{HCl}$); sodium hydroxide($\mathsf{NaOH}$); bromothymol blue; zinc metal; copper (II) sulphate; beakers; test-tubes
\par 
\label{m38719*eip-1902}\noindent{}\textbf{Method: }\label{m38719*id6231}\begin{itemize}[noitemsep]
            \item For each of the salts, dissolve a small amount in water and observe what happens.\item Try dissolving pairs of salts (e.g. potassium nitrate and sodium carbonate) in water and observe what happens.\item Dissolve some sodium carbonate in hydrochloric acid and observe what happens.\item Carefully measure out $20{\mathsf{cm}}^{3}$ of sodium hydroxide into a beaker. \item Add some bromothymol blue to the sodium hydroxide\item Carefully add a few drops of hydrochloric acid to the sodium hydroxide and swirl. Repeat until you notice the colour change.\item Place the zinc metal into the copper sulphate solution and observe what happens.\end{itemize}
\par 
...
\label{m38719*uid112}\item Match the information in column A with the information in column B by writing only the letter (A to I) next to the question number (1 to 7)
    ...
    \tabletail{%
     ...
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
        1. A polar molecule &
        A. ${\mathsf{H}}_{2}{\mathsf{SO}}_{4}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
        2. molecular solution &
        B. ${\mathsf{CaCO}}_{3}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
        3. Mineral that increases water hardness &
        C. $\mathsf{NaOH}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
     ...
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
         &
        I. ${\mathsf{O}}_{2}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    \end{xtabular}
      \end{center}
...
\label{m38719*uid113}\item For each of the following questions, choose the one correct answer from the list provided.
        \item Explain the difference between a weak electrolyte and a strong electrolyte. Give a generalised equation for each.\newline
            ...
            \item Methane (${\mathsf{CH}}_{4}$)\item potassium bromide\item carbon dioxide\item hexane (${\mathsf{C}}_{6}{\mathsf{H}}_{14}$)\item lithium fluoride ($\mathsf{LiF}$)\item magnesium chloride\end{enumerate}
...
A: A white precipitate formed when silver nitrate (${\mathsf{AgNO}}_{3}$) was added to test tube Z.\\
B: A white precipitate formed in test tubes X and Y when barium chloride (${\mathsf{BaCl}}_{2}$) was added.\\
C: The precipitate in test tube X dissolved in hydrochloric acid ($\mathsf{HCl}$) and a gas was released.\\
