...
\label{m38719*id74443}\nopagebreak\noindent{}
    ...
    2{\mathrm{Na}}^{+}+\mathrm{SO}_{4}^{2-}+{\mathrm{Cu}}^{2+}+2{\mathrm{Cl}}^{-}\to 2{\mathrm{Na}}^{+}+\mathrm{SO}_{4}^{2-}+{\mathrm{Cu}}^{2+}+2{\mathrm{Cl}}^{-}\tag{17.23}
      \end{equation}
\end{enumerate}
      \label{m38719*id340954}Table~\ref{tab:solubility} shows some of the general rules about the solubility of different salts based on a number of investigations:\par 
