...
\begin{tabular}{cc}
	...
	\begin{note}
      {tip: }You may sometimes see potential energy written as $\mathrm{PE}$. We will not use this notation in this book, but you may see it in other books.
	\end{note}
	\end{minipage}
	\end{tabular}
	\par
      \label{m38784*id66272}A suitcase, with a mass of $1\phantom{\rule{2pt}{0ex}}\mathrm{kg}$, is placed at the top of a $2\phantom{\rule{2pt}{0ex}}\mathrm{m}$ high cupboard. By lifting the suitcase against the force of gravity, we give the suitcase potential energy. This potential energy can be calculated using (21.1).\par 
      \label{m38784*id66283}If the suitcase falls off the cupboard, it will lose its potential energy. Halfway down the cupboard, the suitcase will have lost half its potential energy and will have only $9,8\phantom{\rule{2pt}{0ex}}\mathrm{J}$ left. At the bottom of the cupboard the suitcase will have lost all it's potential energy and it's potential energy will be equal to zero.\par 
...
\label{m38784*secfhsst!!!underscore!!!id939}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 21.1:  Gravitational potential energy }
      ...
      \label{m38784*id66323}A brick with a mass of $1\phantom{\rule{2pt}{0ex}}\mathrm{kg}$ is lifted to the top of a $4\phantom{\rule{2pt}{0ex}}m$ high roof. It slips off the roof and falls to the ground. Calculate the potential energy of the brick at the top of the roof and on the ground once it has fallen. \par 
      \vspace{5pt}
      ...
      \label{m38784*id66349}\begin{itemize}[noitemsep]
            \leftskip=20pt\rightskip=\leftskip\label{m38784*uid46}\item The mass of the brick is $m=1\phantom{\rule{2pt}{0ex}}\mathrm{kg}$
\label{m38784*uid47}\item The height lifted is $h=4\phantom{\rule{2pt}{0ex}}\mathrm{m}$
\end{itemize}
...
\par
	...
	\hspace*{-50pt}  \includegraphics[width=0.5in]{col11305.imgs/psflag2.png}   & \Definition{   \label{id2553759}\textbf{ Kinetic Energy }} { \label{m38785*meaningfhsst!!!underscore!!!id1048}
      ...
      \end{tabular*}
      \end{definition}
      \label{m38785*id66796}Kinetic energy is the energy an object has because of its motion. This means that any moving object has kinetic energy. The faster it moves, the more kinetic energy it has. Kinetic energy (${E}_{K}$) is therefore dependent on the velocity of the object. The mass of the object also plays a role. A truck of $2 000\phantom{\rule{2pt}{0ex}}\mathrm{kg}$, moving at $100\phantom{\rule{2pt}{0ex}}\mathrm{km}\ensuremath{\cdot}\mathrm{hr}{}^{-1}$, will have more kinetic energy than a car of $500\phantom{\rule{2pt}{0ex}}\mathrm{kg}$, also moving at $100\phantom{\rule{2pt}{0ex}}\mathrm{km}\ensuremath{\cdot}\mathrm{hr}{}^{-1}$. Kinetic energy is defined as:\par 
      \label{m38785*eip-368}
\begin{tabular}{cc}
	\hspace*{-50pt}\raisebox{-8 mm}{\hspace{-0.2in}\includegraphics[width=0.75in]{col11305.imgs/psfact2.png} } & 
	\begin{minipage}{0.85\textwidth}
	\begin{note}
      {note: }You may sometimes see kinetic energy written as $\mathrm{KE}$. This is simply another way to write kinetic energy. We will not use this form in this book, but you may see it written like this in other books.
	\end{note}
	\end{minipage}
	\end{tabular}
	\par
...
\label{m38785*secfhsst!!!underscore!!!id1079}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 21.2:  Calculation of Kinetic Energy }
      ...
      \label{m38785*id66931}A $1\phantom{\rule{2pt}{0ex}}\mathrm{kg}$ brick falls off a $4\phantom{\rule{2pt}{0ex}}\mathrm{m}$ high roof. It reaches the ground with a velocity of $8,85\phantom{\rule{2pt}{0ex}}\mathrm{m}\ensuremath{\cdot}\mathrm{s}{}^{-1}$. What is the kinetic energy of the brick when it starts to fall and when it reaches the ground? \par 
      \vspace{5pt}
      ...
      \label{m38785*id66981}\begin{itemize}[noitemsep]
            \leftskip=20pt\rightskip=\leftskip\label{m38785*uid63}\item The mass of the rock $m=1\phantom{\rule{2pt}{0ex}}\mathrm{kg}$
\label{m38785*uid64}\item The velocity of the rock at the bottom ${v}_{\mathrm{bottom}}=8,85\phantom{\rule{2pt}{0ex}}\mathrm{m}\ensuremath{\cdot}$s${}^{-1}$\end{itemize}
      \label{m38785*id67070}These are both in the correct units so we do not have to worry about unit
conversions.\par 
      \item  
      \label{m38785*id67078}We are asked to find the kinetic energy of the brick at the top and the bottom. From the definition we know that to work out $KE$, we need to know the mass and the velocity of the object and we are given both of these values.\par 
      \item  
...
\par
    ...
    \noindent\textbf{Exercise 21.3:  Mixing Units \& Energy Calculations  }
        ...
        \label{m38785*id67735}A bullet, having a mass of $150\phantom{\rule{2pt}{0ex}}\mathrm{g}$, is shot with a muzzle velocity of $960\phantom{\rule{2pt}{0ex}}\mathrm{m}\ensuremath{\cdot}\mathrm{s}{}^{-1}$. Calculate its kinetic energy. \par 
        \vspace{5pt}
        ...
        \label{m38785*id67785}\begin{itemize}[noitemsep]
            \leftskip=20pt\rightskip=\leftskip\label{m38785*uid66}\item We are given the mass of the bullet $m=150\phantom{\rule{2pt}{0ex}}\mathrm{g}$. This is not the
...
\begin{tabular}{cc}
 ...
 \end{figure}       
    ...
    \begin{array}{ccc}\hfill {E}_{\mathrm{M\; top}}& =& {E}_{\mathrm{M\; bottom}}\hfill \\ \hfill {E}_{\mathrm{P\; top}}+{E}_{\mathrm{K\; top}}& =& {E}_{\mathrm{P\; bottom}}+{E}_{\mathrm{K\; bottom}}\hfill \\ \hfill mgh+\frac{1}{2}m{v}^{2}& =& mgh+\frac{1}{2}m{v}^{2}\hfill \\ \hfill \left(1\right)\left(9,8\right)\left(2\right)+0& =& 0+\frac{1}{2}\left(1\right)\left({v}^{2}\right)\hfill \\ \hfill 19,6\phantom{\rule{3.33333pt}{0ex}}\mathrm{J}& =& \frac{1}{2}{v}^{2}\hfill \\ \hfill 39,2& =& {v}^{2}\hfill \\ \hfill v& =& 6,26\phantom{\rule{0.166667em}{0ex}}\mathrm{m}\ensuremath{\cdot}{\mathrm{s}}^{-1}\hfill \end{array}\tag{21.13}
      \end{equation}
        \label{m38786*id69118}The suitcase will strike the ground with a velocity of $6,26\phantom{\rule{2pt}{0ex}}\mathrm{m}\ensuremath{\cdot}\mathrm{s}{}^{-1}$.\par 
...
\label{m38786*secfhsst!!!underscore!!!id1898}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 21.4:  Using the Law of Conservation of Mechanical Energy }
        ...
        \label{m38786*id69178}During a flood a tree truck of mass $100\phantom{\rule{2pt}{0ex}}\mathrm{kg}$ falls down a waterfall. The waterfall is $5\phantom{\rule{2pt}{0ex}}\mathrm{m}$ high. If air resistance is ignored, calculate\par 
...
\par
    ...
    \noindent\textbf{Exercise 21.5:  Pendulum }
        ...
        \label{m38786*id69704}A $2\phantom{\rule{2pt}{0ex}}\mathrm{kg}$ metal ball is suspended from a rope. If it is released from point $A$ and swings down to the point $B$ (the bottom of its arc):\par 
...
\label{m38786*uid89}\item Calculate the velocity of the ball at point $B$.
\end{enumerate}
