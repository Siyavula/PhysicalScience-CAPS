...
\westep{Use the definition of gravtitational potential energy to calculate the value for the ball when the girl shoots for goal}
\begin{equation*}
E_{P} &=& mgh 
\end{equation*}
...
\Definition{ Kinetic Energy, $E_{K}$ } {Kinetic energy is the energy an object has due to its motion.\\
 Symbol: $E_{K}$ \hspace{2cm} S.I. Unit: $\text{J}$ } 
      \end{tabular*}
      \end{definition}
