...
\par \label{m38736*eip-957}If we know the melting and boiling point of a substance then we can say what state (solid, liquid or gas) it will be in at any temperature. \par \label{m38736*eip-232}
            \subsubsection{ Experiment: States of matter}
            \nopagebreak
...
\label{m38736*id9872}\begin{itemize}[noitemsep]
            \item Place some ice in a beaker\item Measure the temperature of the ice and record it.\item After 10 s measure the temperature again and record it. Repeat every 10 s, until at least 1 minute after the ice has melted.\item Heat some water in a beaker until it boils. Measure and record the temperature of the water.\item Remove the water from the heat and measure the temperature every 10 s, until the beaker is cool to touch\end{itemize}
...
you notice?
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \textbf{Melting 
point (\begin{math}{}^{\ensuremath{{\,}^{\circ}}}\mathrm{C}\end{math})} &
      % align/colidx: left,3
    
    % rowcount: '0' | start: 'false' | colidx: '3'
    
        % Formatting a regular cell and recurring on the next sibling
        \textbf{Boiling point (\begin{math}{}^{\ensuremath{{\,}^{\circ}}}\mathrm{C}\end{math})}% make-rowspan-placeholders
    ...
    % rowcount: '0' | start: 'false' | colidx: '1'
        ...
        % Formatting a regular cell and recurring on the next sibling
        Ethanol (\begin{math}{\mathrm{C}}_{2}{\mathrm{H}}_{6}\mathrm{O}\end{math}) &
      % align/colidx: left,2
...
114,3 &
    ...
    % rowcount: '0' | start: 'false' | colidx: '3'
        ...
        % Formatting a regular cell and recurring on the next sibling
        78,4% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '3'
        ...
        % Formatting a regular cell and recurring on the next sibling
        356,73% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '3'
        ...
        % Formatting a regular cell and recurring on the next sibling
        1465% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    \end{tabular}} % end mytableboxwidth set
...
114,3 &
    ...
    \end{tabular}
      \end{center}
    \begin{center}{\small\bfseries Table 2.2}: The melting and boiling 
points for a number of substances\end{center}
    %\end{table}
...
\begin{tabular}{cc}
	...
	\begin{minipage}{0.85\textwidth}
	\begin{note}
      {note: }Density and viscosity is not in CAPS - Included for Completeness
	\end{note}
	\end{minipage}
	\end{tabular}
	\par
	  ...
	  \begin{tabular*}{15 cm}{m{15 mm}m{}}
	\hspace*{-50pt}  \includegraphics[width=0.5in]{col11305.imgs/psflag2.png}   & \Definition{   \label{id2412522}\textbf{Density}} { \label{m38734*meaningfhsstid83}Density is a measure of the mass of a substance per 
unit volume. } 
      \end{tabular*}
      \end{definition}
...
and molecules that make up matter are held together.\par \label{m38734*secfhsst!!!underscore!!!id289}
            \subsubsection{ Exercise: Forces and boiling point }
            \nopagebreak
...
formula &
    ...
    % rowcount: '0' | start: 'false' | colidx: '3'
        ...
        % Formatting a regular cell and recurring on the next sibling
        Boiling point (\begin{math}{}^{\ensuremath{{\,}^{\circ}}}\mathrm{C}\end{math})% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{CH}}_{4}\end{math} &
      % align/colidx: left,3
    
    % rowcount: '0' | start: 'false' | colidx: '3'
    
        % Formatting a regular cell and recurring on the next sibling
        -161.6% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{C}}_{2}{\mathrm{H}}_{6}\end{math} &
      % align/colidx: left,3
    ...
    % rowcount: '0' | start: 'false' | colidx: '3'
        ...
        % Formatting a regular cell and recurring on the next sibling
        -
88.6% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{C}}_{3}{\mathrm{H}}_{8}\end{math}
 &
      % align/colidx: left,3
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{C}}_{4}{\mathrm{H}}_{10}\end{math} &
      % align/colidx: left,3
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{C}}_{5}{\mathrm{H}}_{12}\end{math} &
      % align/colidx: left,3
    
    % rowcount: '0' | start: 'false' | colidx: '3'
    
        % Formatting a regular cell and recurring on the next sibling
        36.1% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{C}}_{6}{\mathrm{H}}_{14}\end{math} &
      % align/colidx: left,3
    
    % rowcount: '0' | start: 'false' | colidx: '3'
    
        % Formatting a regular cell and recurring on the next sibling
        69% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{C}}_{7}{\mathrm{H}}_{16}\end{math} &
      % align/colidx: left,3
    
    % rowcount: '0' | start: 'false' | colidx: '3'
    
        % Formatting a regular cell and recurring on the next sibling
        98.42% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{C}}_{8}{\mathrm{H}}_{18}\end{math} &
      % align/colidx: left,3
    
    % rowcount: '0' | start: 'false' | colidx: '3'
    
        % Formatting a regular cell and recurring on the next sibling
        125.52% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
    \end{tabular}} % end mytableboxwidth set
...
characteristics of the particles that are in each phase of matter.\par 
    ...
    % rowcount: '0' | start: 'false' | colidx: '4'
        ...
        % Formatting a regular cell and recurring on the next sibling
        Atoms or molecules% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | '' || col4 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
    % align/colidx: left,1
...
moving% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | '' || col4 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
    % align/colidx: left,1
...
solids &
    ...
    % rowcount: '0' | start: 'false' | colidx: '4'
        ...
        % Formatting a regular cell and recurring on the next sibling
        Large spaces because of high energy% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | '' || col4 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
    % align/colidx: left,1
...
particles% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | '' || col4 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
    % align/colidx: left,1
...
solid may become a gas if the temperature is increased. &
      % align/colidx: left,3
    
    % rowcount: '0' | start: 'false' | colidx: '3'
    
        % Formatting a regular cell and recurring on the next sibling
        A liquid becomes a gas if its temperature is increased. It 
becomes a solid if its temperature decreases. &
      % align/colidx: left,4
    
    % rowcount: '0' | start: 'false' | colidx: '4'
    
        % Formatting a regular cell and recurring on the next sibling
        In general a gas becomes a liquid when it is cooled. (In a 
few cases a gas becomes a solid when cooled). Particles have less energy and 
therefore move closer together so that the attractive forces become stronger, 
and the gas becomes a liquid (or a solid.)% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | '' || col4 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
    \end{tabular}} % end mytableboxwidth set
...
and the gas becomes a liquid (or a solid.)% make-rowspan-placeholders
    ...
    \end{tabular}
      \end{center}
    \begin{center}{\small\bfseries Table 2.4}: Table summarising the general features of solids, liquids and 
gases.\end{center}
    %\end{table}
...
gases.\end{center}
    ...
    \par
      ...
      \label{m38730*eip-933}The following presentation is a brief summary of the 
above. Try to fill in the blank spaces before clicking onto the next slide.
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
    \par \label{m38730*id309036}Let's look at an example that 
...
amount of space between them and to make the drawing simpler.\par 
    ...
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38730*uid41!!!underscore!!!media}\label{m38730*uid41!!!underscore!!!printimage}\includegraphics{col11305.imgs/m38730_CG10C2_008.png} % m38730;CG10C2\_008.png;;;6.0;8.5;
...
point} &
    ...
    % rowcount: '0' | start: 'false' | colidx: '3'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \textbf{Boiling point (\begin{math}{}^{\ensuremath{{\,}^{\circ}}}\mathrm{C}\end{math})}
% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}
      %--------------------------------------------------------------------
