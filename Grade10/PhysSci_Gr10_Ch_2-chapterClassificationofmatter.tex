...
\label{m38708*fhsst!!!underscore!!!id193}\begin{definition}
	  \begin{tabular*}{15 cm}{m{15 mm}m{}}
	\hspace*{-50pt}  \includegraphics[width=0.5in]{col11305.imgs/psflag2.png}   & \Definition{   \label{id2406278}\textbf{ Element }} { \label{m38708*meaningfhsst!!!underscore!!!id193}
        An element is a substance that cannot be broken down into other substances through chemical means.
         } 
      \end{tabular*}
      \end{definition}

        \label{m38708*id63334}There are 112 officially named elements and about 118 known elements. Most of these are natural, but some are man-made. The elements we know are represented in the \textbf{Periodic Table of the Elements}, where each element is abbreviated to a \textbf{chemical symbol}. Examples of elements are magnesium (\begin{math}\mathrm{Mg}\end{math}), hydrogen (\begin{math}\mathrm{H}\end{math}), oxygen (\begin{math}\mathrm{O}\end{math}) and carbon (\begin{math}\mathrm{C}\end{math}). On the Periodic Table you will notice that some of the abbreviations do not seem to match the elements they represent. The element iron, for example, has the chemical formula \begin{math}\mathrm{Fe}\end{math}. This is because the elements were originally given Latin names. Iron has the abbreviation \begin{math}\mathrm{Fe}\end{math} because its Latin name is 'ferrum'. In the same way, sodium's Latin name is 'natrium' (\begin{math}\mathrm{Na}\end{math}) and gold's is 'aurum' (\begin{math}\mathrm{Au}\end{math}).\par \label{m38708*eip-775}
\begin{tabular}{cc}
	\hspace*{-50pt}\raisebox{-8 mm}{\hspace{-0.2in}\includegraphics[width=0.75in]{col11305.imgs/psfact2.png} } & 
	...
	\par
      ...
      \label{m38708*uid26}
        ...
        \label{m38708*id63363}A \textbf{compound} is a chemical substance that forms when two or more elements combine in a fixed ratio. Water (\begin{math}\mathrm{H}{}_{2}\mathrm{O}\end{math}), for example, is a compound that is made up of two hydrogen atoms for every one oxygen atom. Sodium chloride (\begin{math}\mathrm{NaCl}\end{math}) is a compound made up of one sodium atom for every chlorine atom. An important characteristic of a compound is that it has a \textbf{chemical formula}, which describes the ratio in which the atoms of each element in the compound occur.\par 
\label{m38708*fhsst!!!underscore!!!id201}\begin{definition}
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38708*uid27!!!underscore!!!media}\label{m38708*uid27!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38708_CG10C1_003.png} % m38708;CG10C1\_003.png;;;6.0;8.5;
...
\label{m38708*eip-id1167351497334}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item Blood\item Argon\item Silicon dioxide (\begin{math}{\mathrm{SiO}}_{2}\end{math})\item Sand and stones\end{enumerate}
...
\label{m38708*eip-id1166921187210}\begin{itemize}[noitemsep]
            \item Hydrogen\item Oxygen\item Nitrogen\item Neon\item Sodium chloride (salt, \begin{math}\mathrm{NaCl}\end{math})\item Potassium permanganate (\begin{math}{\mathrm{KMnO}}_{4}\end{math})\item Water (\begin{math}{\mathrm{H}}_{2}\mathrm{O}\end{math})\item Iron sulphide (\begin{math}\mathrm{FeS}\end{math})\end{itemize}
...
Think about the way that we represent substances microscopically. Would you use just one ball to represent an element or many? Why? \par \label{m38708*secfhsst!!!underscore!!!id212}
    ...
    % rowcount: '0' | start: 'false' | colidx: '1'
        ...
        % Formatting a regular cell and recurring on the next sibling
        limestone (\begin{math}{\mathrm{CaCO}}_{3}\end{math}) &
      % align/colidx: left,2
...
\label{m38708*id63912}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38708*uid30}\item \begin{math}\mathrm{Cu}\end{math}
\label{m38708*uid31}\item iron and sulphur
\label{m38708*uid32}\item \begin{math}\mathrm{Al}\end{math}
\label{m38708*uid33}\item \begin{math}\mathrm{H}{}_{2}\mathrm{SO}{}_{4}\end{math}\label{m38708*uid34}\item \begin{math}\mathrm{SO}{}_{3}\end{math}\end{enumerate}
                \end{enumerate}
...
\label{m38708*id64059}\begin{itemize}[noitemsep]
            \label{m38708*uid36}\item A compound of \textbf{iron} (\begin{math}\mathrm{Fe}\end{math}) and \textsl{sulphur} (\begin{math}\mathrm{S}\end{math}) is \textbf{iron}\hspace{1ex}\textsl{sulph}ide (\begin{math}\mathrm{FeS}\end{math})
\label{m38708*uid37}\item A compound of \textbf{potassium} (\begin{math}\mathrm{K}\end{math}) and \textsl{bromine} (\begin{math}\mathrm{Br}\end{math}) is \textbf{potassium}\hspace{1ex}\textsl{brom}ide (\begin{math}\mathrm{KBr}\end{math})
\label{m38708*uid38}\item A compound of \textbf{sodium} (\begin{math}\mathrm{Na}\end{math}) and \textsl{chlorine} (\begin{math}\mathrm{Cl}\end{math}) is \textbf{sodium}\hspace{1ex}\textsl{chlor}ide (\begin{math}\mathrm{NaCl}\end{math})
\end{itemize}
        \label{m38708*uid39}\item In a compound, the element that is on the left of the Periodic Table, is used \textsl{first} when naming the compound. In the example of \begin{math}\mathrm{NaCl}\end{math}, sodium is a group 1 element on the left hand side of the table, while chlorine is in group 7 on the right of the table. Sodium therefore comes first in the compound name. The same is true for \begin{math}\mathrm{FeS}\end{math} and \begin{math}\mathrm{KBr}\end{math}.
\label{m38708*uid40}\item The \textbf{symbols} of the elements can be used to represent compounds e.g. \begin{math}\mathrm{FeS}\end{math}, \begin{math}\mathrm{NaCl}\end{math}, \begin{math}\mathrm{KBr}\end{math} and \begin{math}\mathrm{H}{}_{2}\mathrm{O}\end{math}. These are called \textbf{chemical formulae}. In the first three examples, the ratio of the elements in each compound is 1:1. So, for \begin{math}\mathrm{FeS}\end{math}, there is one atom of iron for every atom of sulphur in the compound. In the last example (\begin{math}\mathrm{H}{}_{2}\mathrm{O}\end{math}) there are two atoms of hydrogen for every atom of oxygen in the compound.
\label{m38708*uid41}\item A compound may contain \textbf{compound ions}. An ion is an atom that has lost (positive ion) or gained (negative ion) electrons. Some of the more common compound ions and their formulae are given below.
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}\mathrm{CO}_{3}^{2-}\end{math} % make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
         \begin{math}\mathrm{SO}_{4}^{2-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{OH}}^{-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}\mathrm{NH}_{4}^{+}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}\mathrm{NO}_{3}^{-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}\mathrm{HCO}_{3}^{-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}\mathrm{PO}_{4}^{3-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}\mathrm{ClO}_{3}^{-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}{\mathrm{CN}}^{-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}\mathrm{CrO}_{4}^{2-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    % align/colidx: left,1
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
        \begin{math}\mathrm{MnO}_{4}^{-}\end{math}% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
      %--------------------------------------------------------------------
    \end{tabular}} % end mytableboxwidth set
    ...
    \par
  \label{m38708*uid42}\item When there are only two elements in the compound, the compound is often given a \textbf{suffix} (ending) of -ide. You would have seen this in some of the examples we have used so far. For compound ions, when a non-metal is combined with oxygen to form a negative ion (anion) which then combines with a positive ion (cation) from hydrogen or a metal, then the suffix of the name will be ...ate or ...ite. \begin{math}\mathrm{NO}_{3}^{-}\end{math} for example, is a negative ion, which may combine with a cation such as hydrogen (\begin{math}\mathrm{HNO}{}_{3}\end{math}) or a metal like potassium (KNO\begin{math}_\text{3}\end{math}). The \begin{math}\mathrm{NO}_{3}^{-}\end{math} anion has the name nitr\textbf{ate}. \begin{math}\mathrm{SO}_{3}^{2-}\end{math} in a formula is sulph\textbf{ite}, e.g. sodium sulphite (\begin{math}\mathrm{Na}{}_{2}\mathrm{SO}{}_{3}\end{math}).\newline
     \begin{math}\mathrm{SO}_{4}^{2-}\end{math} is sulph\textbf{ate} and \begin{math}\mathrm{PO}_{4}^{3-}\end{math} is phosph\textbf{ate}.
...
\label{m38708*id64977}\begin{itemize}[noitemsep]
            \label{m38708*uid44}\item \begin{math}\mathrm{CO}\end{math} (carbon monoxide) - There is one atom of oxygen for every one atom of carbon
\label{m38708*uid45}\item \begin{math}\mathrm{NO}{}_{2}\end{math} (nitrogen dioxide) - There are two atoms of oxygen for every one atom of nitrogen
\label{m38708*uid46}\item \begin{math}\mathrm{SO}{}_{3}\end{math} (sulphur trioxide) - There are three atoms of oxygen for every one atom of sulphur
\end{itemize}
        \end{enumerate}
...
\label{m38708*eip-178}When working out the formula of a compound from the name we work backwards. For example, if you are given potassium chloride and were told to give its formula you would start by noting that we having potassium and chloride. Next you write down the formula for each of these ions. Potassium is \begin{math}{\mathrm{K}}^{+}\end{math} and chloride is \begin{math}{\mathrm{Cl}}^{-}\end{math}. The final step is to note the charge on each ion to see how it combines. Since both potassium and chlorine have a charge of 1, they combine in a 1:1 ratio. The formula is \begin{math}\mathrm{KCl}\end{math}.\par \label{m38708*notfhsst!!!underscore!!!id252}
\begin{tabular}{cc}
	...
	\begin{note}
      {tip: }
      \label{m38708*id65053}When numbers are written as 'subscripts' in compounds (i.e. they are written below and to the right of the element symbol), this tells us how many atoms of that element there are in relation to other elements in the compound. For example in nitrogen dioxide (\begin{math}{\mathrm{NO}}_{2}\end{math}) there are two oxygen atoms for every one atom of nitrogen. In sulphur trioxide (\begin{math}{\mathrm{SO}}_{3}\end{math}), there are three oxygen atoms for every one atom of sulphur in the compound. Later, when we start looking at chemical equations, you will notice that sometimes there are numbers \textsl{before} the compound name. For example, \begin{math}2\mathrm{H}{}_{2}\mathrm{O}\end{math} means that there are two molecules of water, and that in each molecule there are two hydrogen atoms for every one oxygen atom. \par  
...
\label{m38708*eip-163}We can use these rules to help us name both ionic compounds and covalent compounds (more on these compounds will be covered in a later chapter). However, covalent compounds are often given other names by scientists to simplify the name (or because the molecule was named long before its formula was discovered). For example, if we have 2 hydrogen atoms and one oxygen atom the above naming rules would tell us that the substance is dihydrogen monoxide. But this compound is better known as water! Or if we had 1 carbon atom and 4 hydrogen atoms then the name would be carbon tetrahydride, but scientists call this compound methane.  \par \label{m38708*eip-254}\vspace{.5cm} 
 ...
 \begin{math}\mathrm{K}{\mathrm{MnO}}_{4}\end{math}\item \begin{math}{\mathrm{NH}}_{4}Cl\end{math}\end{enumerate}
...
\label{m38708*id874452}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item In part a) we have \begin{math}{Na}^{+}\end{math} (sodium) and \begin{math}\mathrm{SO}_{4}^{2-}\end{math} (sulphate). In part b) we have \begin{math}{\mathrm{K}}^{+}\end{math} (potassium) and \begin{math}\mathrm{CrO}_{4}^{2-}\end{math} (chromate)\item In part a) the charge on sodium is \begin{math}+1\end{math} and the charge on sulphate is \begin{math}-2\end{math}, so we must have two sodiums for every sulphate. In part b) the charge on potassium is \begin{math}+1\end{math} and the charge on chromate is \begin{math}-2\end{math}, so we must have two potassiums for every chromate.\item a) is \begin{math}{Na}_{2}{\mathrm{SO}}_{4}\end{math} and b) is \begin{math}{\mathrm{K}}_{2}{\mathrm{CrO}}_{4}\end{math}\end{enumerate}
  ...
  \label{m38708*secfhsst!!!underscore!!!id255}
      ...
      \label{m38708*id65118}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m38708*uid47}\item The formula for calcium carbonate is \begin{math}\mathrm{CaCO}{}_{3}\end{math}.
...
\label{m38708*uid49}\item What is the ratio of \begin{math}Ca:\mathrm{C}:\mathrm{O}\end{math} atoms in the formula?
\end{enumerate}
...
\label{m38708*id65189}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38708*uid51}\item \begin{math}\mathrm{KBr}\end{math}
\label{m38708*uid52}\item \begin{math}\mathrm{HCl}\end{math}
\label{m38708*uid53}\item \begin{math}{\mathrm{KMnO}}_{4}\end{math}\label{m38708*uid54}\item \begin{math}{\mathrm{NO}}_{2}\end{math}\label{m38708*uid55}\item \begin{math}{\mathrm{NH}}_{4}\mathrm{OH}\end{math}
\label{m38708*uid56}\item \begin{math}{Na}_{2}{\mathrm{SO}}_{4}\end{math}\end{enumerate}
...
\label{m38708*uid63}\item Refer to the diagram below, showing sodium chloride and water, and then answer the questions that follow.
    ...
    \begin{center}
    \label{m38708*id65419!!!underscore!!!media}\label{m38708*id65419!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38708_CG10C1_004.png} % m38708;CG10C1\_004.png;;;6.0;8.5;
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
    \label{m38708*id65426}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11305.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) llp  &  (2.) lld  &  (3.) llv  &  (4.) llL  & \end{tabular}
      ...
      \label{m38708*id65693}The elements in the Periodic Table can also be divided according to whether they are \textbf{metals}, \textbf{metalloids} or \textbf{non-metals}. On the right hand side of the Periodic Table you can draw a 'zigzag' line (This line starts with Boron (\begin{math}\mathrm{B}\end{math}) and goes down to Polonium (\begin{math}Po\end{math}). This line separates all the elements that are metals from those that are non-metals. Metals are found on the left of the line, and non-metals are those on the right. Along the line you find the metalloids. You should notice that there are more metals then non-metals. Metals, metalloids and non-metals all have their own specific properties.\par 
      \label{m38708*uid76}
            \subsubsection{ Metals}
            \nopagebreak
            
        
        \label{m38708*id65726}Examples of metals include copper (\begin{math}Cu\end{math}), zinc (\begin{math}Zn\end{math}), gold (\begin{math}Au\end{math}), silver (\begin{math}Ag\end{math}), tin (\begin{math}Sn\end{math}) and lead(\begin{math}Pb\end{math}). On the Periodic Table, the metals are on the left of the zig-zag line. There are a large number of elements that are metals. The following are some of the properties of metals:\par 
...
\end{enumerate}
      ...
      \label{m38708*uid93}
        ...
        \label{m38708*id66021}In contrast to metals, non-metals are poor thermal conductors, good electrical insulators (meaning that they do \textsl{not} conduct electrical charge) and are neither malleable nor ductile. The non-metals are found on the right hand side of the Periodic Table, and include elements such as sulphur (\begin{math}\mathrm{S}\end{math}), phosphorus (\begin{math}\mathrm{P}\end{math}), nitrogen (\begin{math}\mathrm{N}\end{math}) and oxygen (\begin{math}\mathrm{O}\end{math}).\par 
...
\end{itemize}
    ...
    \begin{center}
    \label{m38706*id66244!!!underscore!!!media}\label{m38706*id66244!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38706_CG10C1_006.png} % m38706;CG10C1\_006.png;;;6.0;8.5;
...
\label{m38706*eip-316}The following simulation allows you to work through the above activity. For this simulation use the grab bag option to get materials to test. Set up the circuit as described in the activity.
	...
	\begin{figure}[H] % horizontal\label{m38706*id873294}
    \begin{center}
    \label{m38706*id873294!!!underscore!!!media}\label{m38706*id873294!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38706_circuits_test.png} % m38706;circuits\_test.png;;;6.0;8.5;
...
\label{m38706*secfhsst!!!underscore!!!id492}
    ...
    % rowcount: '0' | start: 'false' | colidx: '2'
        ...
        % Formatting a regular cell and recurring on the next sibling
                ...
                \textbf{Thermal Conductivity (\begin{math}\mathrm{W}\ensuremath{\cdot}\mathrm{m}{}^{-1}\ensuremath{\cdot}\mathrm{K}{}^{-1}\end{math}
) }
              % make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}
...
\label{m38706*uid123}\item All the elements are recorded in the \textbf{Periodic Table of the Elements}. Each element has its own chemical symbol. Examples are iron (\begin{math}\mathrm{Fe}\end{math}), sulphur (\begin{math}\mathrm{S}\end{math}), calcium (\begin{math}\mathrm{Ca}\end{math}), magnesium (\begin{math}\mathrm{Mg}\end{math}) and fluorine (\begin{math}\mathrm{F}\end{math}).
\label{m38706*uid124}\item A \textbf{compound} is a substance that is made up of two or more elements that are chemically bonded to each other in a fixed ratio. Examples of compounds are sodium chloride (\begin{math}\mathrm{NaCl}\end{math}), iron sulphide (\begin{math}\mathrm{FeS}\end{math}), calcium carbonate (\begin{math}{\mathrm{CaCO}}_{3}\end{math}) and water (\begin{math}{\mathrm{H}}_{2}\mathrm{O}\end{math}).
...
\label{m38706*uid145}\item Look at the table below. In the first column (A) is a list of substances. In the second column (B) is a description of the group that each of these substances belongs in. Match up the \textsl{substance} in Column A with the \textsl{description} in Column B.
    ...
    % rowcount: '0' | start: 'false' | colidx: '1'
        ...
        % Formatting a regular cell and recurring on the next sibling
        H\begin{math}_\text{2}\end{math}S &
      % align/colidx: left,2
...
\label{m38706*id68358}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38706*uid154}\item \begin{math}\mathrm{NaBr}\end{math}
\label{m38706*uid155}\item \begin{math}{\mathrm{BaSO}}_{4}\end{math}\label{m38706*uid156}\item \begin{math}{\mathrm{SO}}_{2}\end{math} \end{enumerate}
