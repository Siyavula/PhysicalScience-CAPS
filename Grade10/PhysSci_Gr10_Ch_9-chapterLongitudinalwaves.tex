...
\par
    ...
    \begin{center}
    \label{m38782*id292175!!!underscore!!!media}\label{m38782*id292175!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38782_PG11C4_001.png} % m38782;PG11C4\_001.png;;;6.0;8.5;
...
\label{m38782*secfhsst!!!underscore!!!id79}
    ...
    \begin{center}
    \label{m38782*id292211!!!underscore!!!media}\label{m38782*id292211!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38782_PG11C4_002.png} % m38782;PG11C4\_002.png;;;6.0;8.5;
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
    \label{m38782*uid2}\item In which direction does the disturbance move?
...
\end{enumerate}
    ...
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38782*uid5!!!underscore!!!media}\label{m38782*uid5!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38782_PG11C4_003.png} % m38782;PG11C4\_003.png;;;6.0;8.5;
...
\par
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38782*uid7!!!underscore!!!media}\label{m38782*uid7!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38782_PG11C4_004.png} % m38782;PG11C4\_004.png;;;6.0;8.5;
...
\label{m38782*fhsst!!!underscore!!!id129}\begin{definition}
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38782*uid9!!!underscore!!!media}\label{m38782*uid9!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38782_PG11C4_005.png} % m38782;PG11C4\_005.png;;;6.0;8.5;
...
\par
	...
	\hspace*{-50pt}  \includegraphics[width=0.5in]{col11305.imgs/psflag2.png}   & \Definition{   \label{id2445977}\textbf{ Frequency }} { \label{m38782*meaningfhsst!!!underscore!!!id146}
      ...
      \end{definition}
        ...
        \label{m38782*id292523}The \textsl{period} of a longitudinal wave is the time taken by the wave to move one wavelength. As for transverse waves, the symbol \begin{math}T\end{math} is used to represent period and period is measured in seconds (s).\par 
        \label{m38782*id292542}The \textsl{frequency}\begin{math}f\end{math} of a wave is the number of wavelengths per second. Using this definition and the fact that the period is the time taken for 1 wavelength, we can define:\par 
...
\label{m38782*eip-id1170811315120}\begin{itemize}[noitemsep]
            \item \begin{math}v=\mathrm{speed\; in\; m}\ensuremath{\cdot}\mathrm{s}{}^{-1}\end{math}\item \begin{math}f=\mathrm{frequency\; in\; Hz}\end{math}\item \begin{math}\lambda =\mathrm{wavelength\; in\; m}\end{math}\end{itemize}
        \par 
\par
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    f=440\phantom{\rule{4pt}{0ex}}\mathrm{Hz}\lambda =0,784\phantom{\rule{4pt}{0ex}}\mathrm{m}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (8.4)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    v=f\ensuremath{\cdot}\lambda =\left(440\phantom{\rule{0.277778em}{0ex}}\mathrm{Hz}\right)\left(0,784\phantom{\rule{0.166667em}{0ex}}\mathrm{m}\right)=345\phantom{\rule{0.166667em}{0ex}}\mathrm{m}\ensuremath{\cdot}{\mathrm{s}}^{-1}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (8.6)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m38782*id293114}The musical note ``A'' travels at \begin{math}345\phantom{\rule{2pt}{0ex}}\mathrm{m}\ensuremath{\cdot}\mathrm{s}{}^{-1}\end{math}.
 \par 
        \end{enumerate}
...
\end{enumerate}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m38782*id293270}if \begin{math}f\end{math} remains the same and \begin{math}v\end{math} increases, then \begin{math}\lambda \end{math}, the wavelength, must also increase.
 \par 
        \end{enumerate}
...
the sound wave travels through the air. Due to this motion of the particles, there is a constant variation in the pressure in the air. Sound waves are therefore pressure waves. This means that in media where the particles are closer together, sound waves will travel quicker.\par 
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38783*uid18!!!underscore!!!media}\label{m38783*uid18!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38783_PG11C4_010.png} % m38783;PG11C4\_010.png;;;6.0;8.5;
...
\label{m38783*uid23}\item The relationship between the period (\begin{math}T\end{math}) and frequency (\begin{math}f\end{math}) is given by
\label{m38783*id293619}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    T=\frac{1}{f}\phantom{\rule{3pt}{0ex}}\mathrm{or}\phantom{\rule{3pt}{0ex}}f=\frac{1}{T}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (8.8)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
    \label{m38783*uid24}\item The relationship between wave speed (\begin{math}v\end{math}), frequency (\begin{math}f\end{math}) and wavelength (\begin{math}\lambda \end{math}) is given by
...
\end{enumerate}
                \label{m38783*uid41}\item A flute produces a musical sound travelling at a speed of \begin{math}320\phantom{\rule{2pt}{0ex}}\mathrm{m}\ensuremath{\cdot}\mathrm{s}{}^{-1}\end{math}. The frequency of the note is 256 Hz. Calculate:
...
\end{enumerate}
                \label{m38783*uid44}\item A person shouts at a cliff and hears an echo from the cliff 1~s later. If the speed of sound is \begin{math}344\phantom{\rule{2pt}{0ex}}\mathrm{m}\ensuremath{\cdot}\mathrm{s}{}^{-1}\end{math}, how far away is the cliff?\newline
