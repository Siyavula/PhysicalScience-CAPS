...
\Note{You may sometimes see the molar mass written as ${M}_{m}$. We will use $M$ in this book, but you should be aware of the alternate notation.} \label{m38717*id276445}It is worth remembering the following: On the periodic table, the relative atomic mass that is shown can be interpreted in two ways.\par 
      \label{m38717*id276451}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m38717*uid9}\item The mass (in grams) of a \textsl{single, average atom} of that element relative to the mass of an atom of carbon.
...
\begin{eqnarray*}
n & = & \frac{111,7 ~\text{g}}{55,85 ~\text{g} \cdot{\text{mol}}^{-1}} \\
 & = & \frac{111,7 \text{ g} \cdot \text{mol}}{55,85 \text{ g}} \\
 & = & 2 ~\text{mol}
\end{eqnarray*}
...
$5 \text{mol} \times 6,022 \times {10}^{23} \text{ atoms} \cdot \text{mol}^{-1} = 30,115 \times {10}^{23} \text{ atoms}$
...
\Tip{Remember that when you use the equation $\text{n}=\frac{\text{m}}{\text{M}}$, the mass is always in grams ($\text{g}$) and molar mass is in grams per mol ($\text{g}\ensuremath{\cdot}\text{mol}{}^{-1}$). Always write the units next to any number you use in a formula or sum.}
	\par
...
%solution
 ...
 \westep{Find the moles}        
    \begin{equation*}
    n=\frac{127 \text{ g}}{63,55 \text{g} \cdot \text{mol}^{-1}}=2 \text{ mol}
      \end{equation*}
...
\label{m38717*probfhsst!!!underscore!!!id495}
      \label{m38717*id277914}Calculate the number of atoms there are in a sample of aluminium that with a mass of $80,94 \text{ g}$.
      }
{
%solution
\westep{Find the number of moles}
    ...
    \begin{equation*}
    n=\frac{m}{M}=\frac{80,94 \text{ g}}{26,98 \text{ g} \cdot \text{mol}^{-1}}=3 \text{ mol}
      \end{equation*}
      \westep{Find the number of atoms}
      \label{m38717*id278019}Number of atoms in 3 mol aluminium $=3 \times 6,022 \times 10^{23}$ \\
      \label{m38717*id278053}There are $18,069 \times 10^{23}$ aluminium atoms in a sample of $80,94 \text{ g}$.
}
    \end{wex}
    \noindent
...
Oxygen $=16,0 \text{ g} \cdot \text{mol}^{-1}$ 
    ...
    \begin{equation*}
    {M}_{(\text{H}_{2}\text{SO}_{4})}=(2 \times 1,01 \text{ g} \cdot \text{mol}^{-1}) + (32,1 \text{ g} \cdot \text{mol}^{-1}) + (4 \times 16,0 \text{ g} \cdot \text{mol}^{-1} ) = 98,09 \text{ g} \cdot \text{mol}^{-1}
      \end{equation*}
}
    \end{wex}
    \noindent
...
{
%problem
      \label{m38717*id278755}Calculate the number of moles in $1\text{ kg}$ of $\text{MgCl}_{2}$.
     }
{
%solution
...
\label{m38717*id278912}\nopagebreak\noindent{}
    \begin{equation*}
    {M}_{(\text{MgCl}_{2})} = 24,3 \text{ g} \cdot \text{mol}^{-1} + (2 \times 35,45 \text{ g} \cdot \text{mol}^{-1}) = 95,20 \text{g} \cdot \text{mol}^{-1}
      \end{equation*}    
      \westep{Find the number of moles}
      \label{m38717*id279005}\nopagebreak\noindent{}
    \begin{equation*}
    n=\frac{1~000 \text{ g}}{95,21 \text{ g} \cdot \text{mol}^{-1}} = 10,5 \text{ mol}
      \end{equation*}
...
\label{m38717*uid40}\item You have a $46\phantom{\rule{2pt}{0ex}}\text{g}$ sample of nitrogen dioxide ($\text{NO}_{2}$)
\label{m38717*id279631}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38717*uid41}\item How many \textbf{moles} of $\text{NO}_{2}$ are there in the sample?
\item How many moles of nitrogen atoms are there in the sample?
\item How many moles of oxygen atoms are there in the sample?
\label{m38717*uid42}\item How many \textbf{molecules} of $\text{NO}_{2}$ are there in the sample?
...
\label{m38717*id279848}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38717*uid52}\item $10\phantom{\rule{2pt}{0ex}}\text{g}$ of $\text{Na}_{2}\text{SO}{}_{4}$
\label{m38717*uid53}\item $34\phantom{\rule{2pt}{0ex}}\text{g}$ of $\text{Ca(OH)}{}_{2}$
\label{m38717*uid54}\item $2,45\ensuremath{\times}10{}^{23}$ molecules of $\text{CH}{}_{4}$?
\end{enumerate}
%Q3
                \label{m38717*uid55}\item For a sample of $0,2\phantom{\rule{2pt}{0ex}}\text{moles}$ of magnesium bromide ($\text{MgBr}_{2}$), calculate:
...
\end{enumerate}
%Q4
                \label{m38717*uid58}\item You have a sample containing $3\phantom{\rule{2pt}{0ex}}\text{moles}$ of calcium chloride.
...
\label{m38717*id280072}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38717*uid62}\item $3\phantom{\rule{2pt}{0ex}}\text{moles}$ of $\text{NH}{}_{4}\text{OH}$
\label{m38717*uid63}\item $4,2\phantom{\rule{2pt}{0ex}}\text{moles}$ of $\text{Ca}\left(\text{NO}{}_{3}\right){}_{2}$\end{enumerate}
...
\westep{Calculate the molar masses}
      \label{m38712*id280575}$\text{Hydrogen}=1,01 \text{ g} \cdot \text{mol}^{-1}$ \\ 
      \label{m38712*id280588}$\text{Sulphur}=32,1 \text{ g} \cdot \text{mol}^{-1}$ \\
      \label{m38712*id280591}$\text{Oxygen}=4 \times 16=64,0 \text{ g} \cdot \text{mol}^{-1}$
    ...
    \begin{equation*}
    \frac{2,02 \text{ g} \cdot \text{mol}^{-1}}{98,12 \text{ g} \cdot \text{mol}^{-1}}\ensuremath{\times}100\%=2,06\%
      \end{equation*}
    ...
    \begin{equation*}
    \frac{32,1 \text{ g} \cdot \text{mol}^{-1}}{98,12 \text{ g} \cdot \text{mol}^{-1}}\ensuremath{\times}100\%=32,71\%
      \end{equation*}
    ...
    \begin{equation*}
    \frac{64,0 \text{ g} \cdot \text{mol}^{-1}}{98,12 \text{ g} \cdot \text{mol}^{-1}}\ensuremath{\times}100\%=65,23\%
      \end{equation*}
...
\westep{Find the mass of oxygen}
    ...
    \begin{equation*}
    239 \text{ g}-207 \text{ g}=32\phantom{\rule{2pt}{0ex}}\text{g}
      \end{equation*}
    ...
    \begin{equation*}
    n = \frac{207 \text{ g}}{207 \text{ g} \cdot \text{mol}^{-1}}=1\phantom{\rule{2pt}{0ex}}\text{mol}
      \end{equation*}
    ...
    \begin{equation*}
    n= \frac{32 \text{ g}}{16,0 \text{ g} \cdot \text{mol}^{-1}}=2\phantom{\rule{2pt}{0ex}}\text{mol}
      \end{equation*}
...
\westep{Find the mass}
    ...
    \begin{eqnarray*}
{\text{n}}_{\text{C}} & = & \frac{39,9 \text{ g}}{12,01 \text{ g} \cdot \text{mol}^{-1}} = 3,33 \text{ mol} \\
{\text{n}}_{\text{H}} & = & \frac{6,7 \text{ g}}{1,01 \text{ g} \cdot \text{mol}^{-1}} = 6,7 \text{ mol} \\
{\text{n}}_{\text{O}} & = & \frac{53,4 \text{ g}}{16 \text{ g} \cdot \text{mol}^{-1}} = 3,34 \text{ mol}
      \end{eqnarray*}
...
\label{m38712*id64827}Aluminium trichloride (${\text{AlCl}}_{3}$) is an ionic substance that forms crystals in the solid phase. Water molecules may be trapped inside the crystal lattice. We represent this as: ${\text{AlCl}}_{3}\ensuremath{\cdot}n{\text{H}}_{2}\text{O}$. A learner heated some aluminium trichloride crystals until all the water had evaporated and found that the mass after heating was $2,8\phantom{\rule{2pt}{0ex}}\text{g}$. The mass before heating was $5\phantom{\rule{2pt}{0ex}}\text{g}$. What is the number of moles of water molecules in the aluminium trichloride before heating?
}
{
%solution
...
\begin{tabular}{r@{:}l}
 $\text{AlCl}_3~$ & $~\text{H}_{2}\text{O}$ \\
$0,02099...~$ & $~0,122...$ \\
$\frac{0,02099}{0,02099}~$ & $~\frac{0,122}{0,02099}$ \\
$1~$ & $~6$ \\
\end{tabular}\\
...
\section{Amount of substance}
 ...
 \Definition{   \label{id2504818}Molar volume of gases} { \label{m38712*eip-id1168053572222}1 mole of gas occupies $22,4{\text{ dm}}^{3}$ at standard temperature and pressure. } 
...
\end{center}
 \end{figure}
      \label{m38712*id282881}For this equation, the units for volume are $\text{dm}{}^{3}$ (which is equal to litres). Therefore, the unit of concentration is $\text{mol}\ensuremath{\cdot}{\text{dm}}^{-3}$.
	\par
...
%problem
      ...
      \label{m38712*id283003}If $3,5\text{ g}$ of sodium hydroxide ($\text{NaOH}$) is dissolved in $2,5\phantom{\rule{2pt}{0ex}}{\text{dm}}^{3}$ of water, what is the concentration of the solution in $\text{mol}\ensuremath{\cdot}{\text{dm}}^{-3}$? 
}
{
%solution
\westep{Find the number of moles of sodium hydroxide} 
    ...
    \begin{equation*}
    \text{n}=\frac{\text{m}}{\text{M}}=\frac{3,5 \text{ g}}{40 \text{ g} \cdot \text{mol}^{-1}}=0,0875 \text{mol}
      \end{equation*}
...
\westep{Calculate the number of moles}
    ...
    \begin{equation*}
    \text{m}=\text{n} \times \text{M} = 0,2 \text{ mol} \times 158,04 \text{ g} \cdot \text{mol}^{-1} = 31,61 \text{ g}
      \end{equation*}
      \label{m38712*id283435}The mass of $\text{KMnO}{}_{4}$ that is needed is $31,61 \text{ g}$.
...
\westep{Convert the given volume to the correct units}
    \begin{equation*}
    \text{V}= 500 \text{cm}^{3} \frac{1 \text{ dm}^{3}}{1 000 \text{ cm}^{3}}=0,5\phantom{\rule{2pt}{0ex}}{\text{dm}}^{3}
      \end{equation*}
      \westep{Find the number of moles} 
    ...
    \text{m}=\text{n} \times \text{M}= 0,005 \text{ mol} \times 58,45 \text{ g} \cdot \text{mol}^{-1} = 0,29 \text{ g}
      \end{equation*}
      \label{m38712*id283684}The mass of sodium chloride needed is $0,29 \text{ g}$
...
{
%problem
What volume of oxygen at S.T.P. is needed for the complete combustion of $2\phantom{\rule{2pt}{0ex}}{\text{dm}}^{3}$ of propane ($\text{C}{}_{3}\text{H}{}_{8}$)? (Hint: $\text{CO}{}_{2}$ and $\text{H}{}_{2}\text{O}$ are the products in this reaction (and in all combustion reactions))
      }
{
%solution
...
\westep{Write the balanced equation}
    ...
    \begin{equation*}
    \text{n}=\frac{\text{m}}{\text{M}}=\frac{5,6 \text{ g}}{55,85 \text{ g} \cdot \text{mol}^{-1}}=0,1\text{ mol}
      \end{equation*}
    ...
    \begin{equation*}
    m=n\ensuremath{\times}M=0,1 \text{ mol} \times 87,9 \text{ g} \cdot \text{ mol}^{-1}=8,82 \text{ g}
      \end{equation*}
...
\end{equation*}
 ...
 \par \label{m38712*secfhsst!!!underscore!!!id2067}
      \noindent 
...
\westep{Calculate the number of moles of the given substance}
    \begin{equation*}
    \text{n} ({\text{H}}_{2}{\text{SO}}_{4}) = \frac{\text{m}}{\text{M}} = \frac{2~000 \text{ g}}{98,12 \text{ g} \cdot {\text{mol}}^{-1}} = 20,383...\phantom{\rule{2pt}{0ex}}\text{ mol}
      \end{equation*}
      \westep{Find the mole ratio}  
...
\westep{Write the answer}
    ...
    m=n \times M = 20,41\text{ mol} \times 132 \text{ g} \cdot {\text{mol}}^{-1} = 2694 \text{ g}
      ...
      \label{m38712*id285362}The maximum amount of ammonium sulphate that can be produced is $2,694 \text{ kg}$.
...
\westep{Find the number of moles of barium chloride}
    ...
    \begin{equation*}
    n=\frac{m}{M}=\frac{2 \text{ g}}{208,24 \text{ g} \cdot \text{mol}^{-1}}=0,0096 \text{ mol}
      \end{equation*}
    ...
    \begin{equation*}
    m=n \times M = 0,0096 \text{ mol} \times 98,086 \text{ g} \cdot \text{mol}^{-1} = 0,94 \text{ g}
      \end{equation*}
      \label{m38717*id279505}(answer to 1) 
      \westep{Find the moles of hydrochloric acid} 
      \label{m38717*id279513}According to the balanced equation, 2 moles of $\text{HCl}$ are produced for every 1 mole of the two reactants. Therefore the number of moles of $\text{HCl}$ produced is ($2 \times 0,0096 \text{ mol}$), which equals $0,0096 \text{mol}$.
      \westep{Find the mass of hydrochloric acid}
      \label{m38717*id279531}\nopagebreak\noindent{}
        
    \begin{equation*}
    m=n \times M = 0,0192 \text{ mol} \times 35,73 \text{ g} \cdot \text{ mol} = 0,69 \text{ g}
      \end{equation*}
...
${\text{B}}_{2}{\text{H}}_{6}\left(\text{g}\right)+3{\text{O}}_{2}\left(\text{g}\right)\to 2\text{H}\text{B}{\text{O}}_{2}\left(\text{g}\right)+2{\text{H}}_{2}\text{O}\left( \ell \right)$\\
...
\label{m38712*uid108}\item The \textbf{mole (n)} is an SI unit that is used to describe an amount of substance that contains the same number of particles as there are atoms in $12\phantom{\rule{2pt}{0ex}}\text{g}$ of carbon.
\label{m38712*uid109}\item The number of particles in a mole is called \textbf{Avogadros constant} and its value is $6,022\ensuremath{\times}{10}^{23}$. These particles could be atoms, molecules or other particle units, depending on the substance.
...
\label{m38712*uid117}\item One mole of gas occupies a volume of $22,4\phantom{\rule{2pt}{0ex}}{\text{dm}}^{3}$ at S.T.P..
...
\label{m38712*uid119}\item The concentration of a solution is measured in $\phantom{\rule{2pt}{0ex}}\text{mol}\ensuremath{\cdot}{\text{dm}}^{-3}$.
...
\end{enumerate}
%Q2
                \label{m38712*uid126}\item Choose the one correct answer from those given.
...
\label{m38712*uid129}\item the number of atoms of $\text{Cl}$ in the product is $0,6022\ensuremath{\times}{10}^{23}$
\label{m38712*uid130}\item the number of atoms of $\text{Mg}$ is $0,05$
...
\label{m38712*id286339}\begin{enumerate}[noitemsep, label=\textbf{\roman*}. ] 
            \label{m38712*uid133}\item $32 \text{ g}$
\label{m38712*uid134}\item $0,125 \text{ g}$
\label{m38712*uid135}\item $64 \text{ g}$
\label{m38712*uid136}\item $0,063 \text{ g}$
\end{enumerate}
%Q2c  
...
\end{enumerate}
%Q2d 
               \label{m38712*uid142}\item The concentration of a $150\phantom{\rule{2pt}{0ex}}{\text{cm}}^{3}$ solution, containing $5 \text{ g}$ of $\text{NaCl}$ is...
\label{m38712*id286512}\begin{enumerate}[noitemsep, label=\textbf{\roman*}. ] 
            \label{m38712*uid143}\item $0,09 \text{ mol} \cdot \text{dm}^{-3}$
\label{m38712*uid144}\item $5,7 \times 10^{-4} \text{ mol} \cdot \text{dm}^{-3}$
\label{m38712*uid145}\item $0,57 \text{ mol} \cdot \text{dm}^{-3}$
\label{m38712*uid146}\item $0,03 \text{ mol} \cdot \text{dm}^{-3}$
\end{enumerate}
                \end{enumerate}
%Q3
...
\item $9,6 \text{ kg}$ of titanium tetrachloride (${\text{TiCl}}_{4}$)\end{enumerate}
%Q4 
...
\item Lithium hydroxide ($\text{LiOH}$)\end{enumerate}
%Q6
...
\label{m38712*id73222}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
...
$\text{Zn}+\text{S}\to \text{ZnS}$\label{m38717*id280179}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
