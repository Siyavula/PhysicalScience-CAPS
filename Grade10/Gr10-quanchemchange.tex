...
\label{m38712*uid108}\item The \textbf{mole (n)} is an SI unit that is used to describe an amount of substance that contains the same number of particles as there are atoms in $12,0 \text{ g}$ of carbon.
...
\label{m38712*uid117}\item One mole of gas occupies a volume of $22,4 {\text{ dm}}^{3}$ at S.T.P..
...
\label{m38712*id286019}\nopagebreak\noindent{}
    ...
    \text{C}=\frac{\text{n}}{\text{V}}
      \end{equation*}
where C is the concentration (in $\text{mol} \cdot {\text{dm}}^{-3}$), n is the number of moles of solute dissolved in the solution and V is the volume of the solution (in ${\text{dm}}^{-3}$).
\label{m38712*uid119}\item The concentration of a solution is measured in $\text{mol} \cdot {\text{dm}}^{-3}$.
