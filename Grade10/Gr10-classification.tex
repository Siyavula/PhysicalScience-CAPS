...
\SpecialCoor
%\psgrid[gridcolor=lightgray]
\def\fe{\pscircle[fillcolor=violet!15!lightgray!75!blue,fillstyle=solid](0,0){0.4}\rput(0,0){Fe}}
...
\psset{unit=1}
\pspolygon[fillstyle=solid,fillcolor=teal](0,3)(0,4)(1,4)(1,3)(0,3)
\pspolygon[fillstyle=solid,fillcolor=gray](0,-1)(0,3)(2,3)(2,1)(12,1)(12,2)(13,2)(13,0)(14,0)(14,-1)(0,-1)
\pspolygon[fillstyle=solid,fillcolor=cyan](12,2)(12,3)(13,3)(13,2)(12,2)
\pspolygon[fillstyle=solid,fillcolor=cyan](13,0)(13,2)(14,2)(14,1)(15,1)(15,0)(16,0)(16,-1)(14,-1)(14,0)(13,0)
\pspolygon[fillstyle=solid,fillcolor=teal](14,2)(13,2)(13,3)(17,3)(17,4)(18,4)(18,-1)(16,-1)(16,0)(15,0)(15,1)(14,1)(14,2)
...
%     \nopagebreak
    \label{m38706*cid6}
            \section{Electrical conductors and insulators}
...
\end{enumerate}
        \par 
      \label{m38706*id66291}\noindent{}\textbf{Results: } Record your results in the table below:
    ...
    \end{tabular}
      \end{center}
\end{table}
      \label{m38706*id66494}\noindent{}\textbf{Conclusions: } In the substances that were tested, the metals were able to conduct electricity and the non-metals were not. Metals are good electrical conductors and non-metals are not. }
            \end{g_experiment}
\simulation{The following simulation allows you to work through the above activity. For this simulation use the grab bag option to get materials to test. Set up the circuit as described in the activity.}{lbK}
...
\textbf{5. } steel & \textbf{E. } a homogeneous mixture \\ \hline
    \end{tabular}
      \end{center}
\end{table}
\item You are given a test tube that contains a mixture of iron filings and sulphur. You are asked to weigh the amount of iron in the sample.
\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
\item Suggest one method that you could use to separate the iron filings from the sulphur.
...
\practiceinfo
 ...
 (1.) ll6 & (2.) llF &  (3.) llG  &  (4.) lbm  &  (5.) llA  &  (6.) llo  &  (7.) lbM  &  (8.) lby  &  (9.) llH  & \end{tabular}}
\end{eocexercises}
