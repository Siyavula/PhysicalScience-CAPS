...
%     Question
    {
    What is the chemical name for \label{m38708*id734}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ]
    \leftskip=20pt\rightskip=\leftskip\item  $\mathrm{K}{\mathrm{MnO}}_{4}$\item
    ${\mathrm{NH}}_{4}Cl$\end{enumerate}
    }
% Answer
    {
%     \label{m38708*id7432}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
%             \leftskip=20pt\rightskip=\leftskip\item 
    \westep{}{ For a) we have potassium and the permanganate ion. For b) we have the ammonium ion and chlorine. }
    \westep{}{ For a) we list the potassium first and the permanganate ion second. So a) is potassium permanganate. For b) we list the ammonium ion first and change the ending of chlorine to -ide. So b) is ammonium chloride.}
% \item 
% \end{enumerate}
    }
    \end{wex}
...
% Answer
    {
    \westep{}{In part a) we have ${Na}^{+}$ (sodium) and $\mathrm{SO}_{4}^{2-}$ (sulphate). In part b) we have ${\mathrm{K}}^{+}$ (potassium) and $\mathrm{CrO}_{4}^{2-}$ (chromate)}
    \westep{}{In part a) the charge on sodium is $+1$ and the charge on sulphate is $-2$, so we must have two sodiums for every sulphate. In part b) the charge on potassium is $+1$ and the charge on chromate is $-2$, so we must have two potassiums for every chromate.}
    \westep{}{a) is ${Na}_{2}{\mathrm{SO}}_{4}$ and b) is ${\mathrm{K}}_{2}{\mathrm{CrO}}_{4}$}
