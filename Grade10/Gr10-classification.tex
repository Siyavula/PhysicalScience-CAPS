...
\item A compound may contain \textbf{ions}. These ions can be either simple (consist of only one element) or compound (consist of several elements). Some of the more common ions and their formulae are given in table \ref{tab:cations} and in table \ref{tab:anions}. You should know all these ions.\\
...
\westep{Write down the formula}
$\mathrm{MgO}$ (\textboldface{not} $\mathrm{Mg}_{2}\mathrm{O}_{2}$) 
}
\end{wex} \vspace{-2cm}
...
${\mathrm{Cu}}({\mathrm{NO}}_{3})_{2}$
    ...
    \end{wex}
\Tip{Notice how in the last example we wrote $\mathrm{NO}_{3}^{−}$ inside brackets. We do this to indicate that $\mathrm{NO}_{3}^{−}$ is a compound ion and that there are two of these ions bonded to one copper ion.}
...
\pspolygon[fillstyle=solid,fillcolor=blue](12,2)(12,3)(13,3)(13,2)(12,2)
\pspolygon[fillstyle=solid,fillcolor=blue](13,0)(13,2)(14,2)(14,1)(15,1)(15,0)(13,0)
\pspolygon[fillstyle=solid,fillcolor=red](14,2)(13,2)(13,3)(17,3)(17,4)(18,4)(18,0)(15,0)(15,1)(14,1)(14,2)
\uput[l](3,0.5){\Large{Metals}}
\uput[l](15,0.5){Metalloids}
\uput[l](13.1,2.5){Metalloids}
...
\begin{minipage}{.5\textwidth}
\begin{center}
 \includegraphics[width=.5\textwidth]{photos/sulphurby-nickstone333.jpg}\par
...
\begin{minipage}{.5\textwidth}
\begin{center}
 \includegraphics[height=.5\textwidth]{photos/Tripp.jpg}\par
...
\label{m38706*secfhsst!!!underscore!!!id492}
            \begin{g_experiment}{Investigation : A closer look at thermal conductivity}
{            \nopagebreak
