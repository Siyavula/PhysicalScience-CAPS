...
%NTS replace the following table with the full one whne Bridget has typed it up
...
\item ${\mathrm{NH}}_{4}Cl$\end{enumerate}
  \par 
\vspace{5pt}}
...
In part a) we have ${Na}^{+}$ (sodium) and $\mathrm{SO}_{4}^{2-}$ (sulphate). In part b) we have ${\mathrm{K}}^{+}$ (potassium) and $\mathrm{CrO}_{4}^{2-}$ (chromate)}
...
{\westep{write the answer} a) is ${Na}_{2}{\mathrm{SO}}_{4}$ and b) is ${\mathrm{K}}_{2}{\mathrm{CrO}}_{4}$}}
    \end{wex}
%    \end{mdframed}
%    }
%    \noindent
