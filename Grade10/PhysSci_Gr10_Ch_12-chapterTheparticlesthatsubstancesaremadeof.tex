         \chapter{The particles that substances are made of}
...
(Figure~11.1).
	...
	\begin{figure}[H] % horizontal\label{m38120*uid3}
    \begin{center}
    \label{m38120*uid3!!!underscore!!!media}\label{m38120*uid3!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38120_CG10C2_001.png} % m38120;CG10C2\_001.png;;;6.0;8.5;
        
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
	  \small \textbf{Figure 11.1: }Diagram showing (a) the molecular, (b) 
...
simplified example is shown in Figure~11.2.
	...
	\begin{figure}[H] % horizontal\label{m38120*uid6}
    \begin{center}
    \label{m38120*uid6!!!underscore!!!media}\label{m38120*uid6!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38120_CG10C2_002.png} % m38120;CG10C2\_002.png;;;6.0;8.5;
...
different ways.
	...
	\begin{figure}[H] % horizontal\label{m38120*uid8}
    \begin{center}
    \label{m38120*uid8!!!underscore!!!media}\label{m38120*uid8!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38120_CG10C2_003.png} % m38120;CG10C2\_003.png;;;6.0;8.5;
...
are attached to one oxygen atom. This is a simple molecule.
 ...
 \end{figure}   
	...
	\begin{figure}[H] % horizontal\label{m38120*uid9}
    \begin{center}
    \label{m38120*uid9!!!underscore!!!media}\label{m38120*uid9!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38120_CG10C2_004.png} % m38120;CG10C2\_004.png;;;6.0;8.5;
...
bonded to four carbon atoms, but some of these carbon atoms have been omitted.
	...
	\begin{figure}[H] % horizontal\label{m38120*uid10}
    \begin{center}
    \label{m38120*uid10!!!underscore!!!media}\label{m38120*uid10!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38120_CG10C2_005.png} % m38120;CG10C2\_005.png;;;6.0;8.5;
...
\begin{tabular}{cc}
	...
	\begin{note}
      {note: }Diamonds are most often thought of in terms of their use in the 
...
representing molecules. 
    ...
    \begin{center}
    \label{m38120*uid101!!!underscore!!!media}\label{m38120*uid10123!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38120_canvasmol.png} % m38120;canvasmol.png;;;6.0;8.5;
...
questions that follow:
    ...
    \begin{center}
    \label{m38120*id308155!!!underscore!!!media}\label{m38120*id308155!!!underscore!!!printimage}\includegraphics[width=300px]{col11305.imgs/m38120_CG10C2_006.png} % m38120;CG10C2\_006.png;;;6.0;8.5;
