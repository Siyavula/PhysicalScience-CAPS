...
\label{m38704*secfhsst!!!underscore!!!id98}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 5.1:  Covalent bonding }
        ...
        \label{m38704*id139037}A chlorine atom has 17 electrons, and an electron configuration of $1\mathrm{s}{}^{2}2\mathrm{s}{}^{2}2\mathrm{p}{}^{6}3\mathrm{s}{}^{2}3\mathrm{p}{}^{5}$. A hydrogen atom has only 1 electron, and an electron configuration of $1\mathrm{s}{}^{1}$.\par 
        \item  
    ...
    \begin{center}
    \label{m38704*uid7!!!underscore!!!media}\label{m38704*uid7!!!underscore!!!printimage}\includegraphics[width=8cm]{col11305.imgs/m38704_CG11C1_003.png} % ;CG11C1\_003.png;;;6.0;8.5;
      \vspace{2pt}
...
\par
    ...
    \begin{center}
    \label{m38704*uid8!!!underscore!!!media}\label{m38704*uid8!!!underscore!!!printimage}\includegraphics[width=8cm]{col11305.imgs/m38704_CG11C1_004.png} % ;CG11C1\_004.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
...
\label{m38704*secfhsst!!!underscore!!!id142}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 5.3:  Covalent bonding involving a double bond }
        ...
        \label{m38704*solfhsst!!!underscore!!!id147}\noindent\textbf{Solution to Exercise } \label{m38704*listfhsst!!!underscore!!!id147}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m38704*id139400}Each oxygen atom has 8 electrons, and their electron configuration is $1\mathrm{s}{}^{2}2\mathrm{s}{}^{2}2\mathrm{p}{}^{4}$.\par 
        \item  
    ...
    \begin{center}
    \label{m38704*uid9!!!underscore!!!media}\label{m38704*uid9!!!underscore!!!printimage}\includegraphics[width=8cm]{col11305.imgs/m38704_CG11C1_005.png} % ;CG11C1\_005.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
...
\par 
  \label{m38704**end}
    ...
    \begin{center}
    \label{m38701*id140144!!!underscore!!!media}\label{m38701*id140144!!!underscore!!!printimage}\includegraphics[width=1cm]{col11305.imgs/m38701_CG11C1_006.png} % m38701;CG11C1\_006.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
    ...
    \begin{center}
    \label{m38701*id140157!!!underscore!!!media}\label{m38701*id140157!!!underscore!!!printimage}\includegraphics[width=1cm]{col11305.imgs/m38701_CG11C1_007.png} % m38701;CG11C1\_007.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
    ...
    \begin{center}
    \label{m38701*id140171!!!underscore!!!media}\label{m38701*id140171!!!underscore!!!printimage}\includegraphics[width=2cm]{col11305.imgs/m38701_CG11C1_008.png} % m38701;CG11C1\_008.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
...
\label{m38701*secfhsst!!!underscore!!!id219}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 5.4:  Lewis notation: Simple molecules
      ...
      \label{m38701*id140201}Represent the molecule $\mathrm{H}{}_{2}\mathrm{O}$ using Lewis notation\par 
      \vspace{5pt}
      \label{m38701*solfhsst!!!underscore!!!id225}\noindent\textbf{Solution to Exercise } \label{m38701*listfhsst!!!underscore!!!id225}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
      \label{m38701*id140248}The electron configuration of hydrogen is $1\mathrm{s}{}^{1}$ and the electron configuration for oxygen is $1\mathrm{s}{}^{2}2\mathrm{s}{}^{2}2\mathrm{p}{}^{4}$. Each hydrogen atom has one valence electron, which is unpaired, and the oxygen atom has six valence electrons with two unpaired.\par 
    \setcounter{subfigure}{0}
	\begin{figure}[H] % horizontal\label{m38701*uid15}
    \begin{center}
    \label{m38701*uid15!!!underscore!!!media}\label{m38701*uid15!!!underscore!!!printimage}\includegraphics[width=4cm]{col11305.imgs/m38701_CG11C1_009.png} % ;CG11C1\_009.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
    ...
    \begin{center}
    \label{m38701*uid16!!!underscore!!!media}\label{m38701*uid16!!!underscore!!!printimage}\includegraphics[width=2cm]{col11305.imgs/m38701_CG11C1_010.png} % ;CG11C1\_010.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
...
\label{m38701*secfhsst!!!underscore!!!id245}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 5.5:  Lewis notation: Molecules with multiple bonds
      ...
      \label{m38701*id140364}Represent the molecule $\mathrm{HCN}$ (hydrogen cyanide) using Lewis notation\par 
      \vspace{5pt}
      \label{m38701*solfhsst!!!underscore!!!id251}\noindent\textbf{Solution to Exercise } \label{m38701*listfhsst!!!underscore!!!id251}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
      \label{m38701*id140394}The electron configuration of hydrogen is $1\mathrm{s}{}^{1}$, the electron configuration of nitrogen is $1\mathrm{s}{}^{2}2\mathrm{s}{}^{2}2\mathrm{p}{}^{3}$ and for carbon is $1\mathrm{s}{}^{2}2\mathrm{s}{}^{2}2\mathrm{p}{}^{2}$. This means that hydrogen has one valence electron which is unpaired, carbon has four valence electrons, all of which are unpaired, and nitrogen has five valence electrons, three of which are unpaired.\par 
    \setcounter{subfigure}{0}
	\begin{figure}[H] % horizontal\label{m38701*uid17}
    \begin{center}
    \label{m38701*uid17!!!underscore!!!media}\label{m38701*uid17!!!underscore!!!printimage}\includegraphics[width=4cm]{col11305.imgs/m38701_CG11C1_011.png} % ;CG11C1\_011.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
      \item  
      \label{m38701*id140504}The $\mathrm{HCN}$ molecule is represented below. Notice the three electron pairs between the nitrogen and carbon atom. Because these three covalent bonds are between the same two atoms, this is a \textsl{triple} bond.\par 
    \setcounter{subfigure}{0}
	\begin{figure}[H] % horizontal\label{m38701*uid18}
    \begin{center}
    \label{m38701*uid18!!!underscore!!!media}\label{m38701*uid18!!!underscore!!!printimage}\includegraphics[width=3cm]{col11305.imgs/m38701_CG11C1_012.png} % ;CG11C1\_012.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
...
\label{m38701*secfhsst!!!underscore!!!id271}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 5.6:  Lewis notation: Atoms with variable valencies
      ...
      \label{m38701*id140557}Represent the molecule $\mathrm{H}{}_{2}\mathrm{S}$ (hydrogen sulphide) using Lewis notation\par 
      \vspace{5pt}
      \label{m38701*solfhsst!!!underscore!!!id277}\noindent\textbf{Solution to Exercise } \label{m38701*listfhsst!!!underscore!!!id277}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
      \label{m38701*id140615}Hydrogen has an electron configuration of $1\mathrm{s}{}^{1}$ and sulphur has an electron configuration of $1\mathrm{s}{}^{2}2\mathrm{s}{}^{2}2{p}{}^{6}3\mathrm{s}{}^{2}3\mathrm{p}{}^{4}$. Each hydrogen atom has one valence electron which is unpaired, and sulphur has six valence electrons. Although sulphur has a variable valency, we know that the sulphur will be able to form 2 bonds with the hydrogen atoms. In this case, the valency of sulphur must be two.\par 
    \setcounter{subfigure}{0}
	\begin{figure}[H] % horizontal\label{m38701*uid19}
    \begin{center}
    \label{m38701*uid19!!!underscore!!!media}\label{m38701*uid19!!!underscore!!!printimage}\includegraphics[width=4cm]{col11305.imgs/m38701_CG11C1_013.png} % ;CG11C1\_013.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
    ...
    \begin{center}
    \label{m38701*uid20!!!underscore!!!media}\label{m38701*uid20!!!underscore!!!printimage}\includegraphics[width=2cm]{col11305.imgs/m38701_CG11C1_014.png} % ;CG11C1\_014.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
\end{enumerate}
    ...
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38701*uid21!!!underscore!!!media}\label{m38701*uid21!!!underscore!!!printimage}\includegraphics[width=3cm]{col11305.imgs/m38701_CG11C1_015.png} % m38701;CG11C1\_015.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
 ...
 \end{figure}       
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38701*uid22!!!underscore!!!media}\label{m38701*uid22!!!underscore!!!printimage}\includegraphics[width=3cm]{col11305.imgs/m38701_CG11C1_016.png} % m38701;CG11C1\_016.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
...
\end{enumerate}
    ...
    \begin{center}
    \label{m38701*id141174!!!underscore!!!media}\label{m38701*id141174!!!underscore!!!printimage}\includegraphics[width=3cm]{col11305.imgs/m38701_CG11C1_018.png} % m38701;CG11C1\_018.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
...
\label{m38694*fhsst!!!underscore!!!id582}\begin{definition}
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m38694*uid78!!!underscore!!!media}\label{m38694*uid78!!!underscore!!!printimage}\includegraphics[height=8cm]{col11305.imgs/m38694_CG11C1_022.png} % m38694;CG11C1\_022.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
...
\label{m38689*secfhsst!!!underscore!!!id646}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 5.7:  Formulae of covalent compounds }
        ...
        \label{m38689*id143771}$\mathrm{H}{}_{2}\mathrm{O}$.\par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
    }
...
of oxygen.\par 
        ...
        \label{m38689*id143885}$\mathrm{MgO}$
        \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
the valency of chlorine is 1. In a molecule of copper (II) chloride, two atoms of chlorine will combine with one atom of copper.\par 
        ...
        \label{m38689*id143999}$\mathrm{CuCl}{}_{2}$
        \par 
 \end{enumerate}
    \end{exercise}
    \end{mdframed}
    ...
    \tabletail{%
     ...
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        ...
        $\mathrm{CO}_{3}^{2-}$ &
        Nitrite &
        $\mathrm{NO}_{2}^{-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Sulphate &
        $\mathrm{SO}_{4}^{2-}$ &
        Hydrogen sulphite &
        $\mathrm{HSO}_{3}^{-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Hydroxide &
        ${\mathrm{OH}}^{-}$ &
        Hydrogen sulphate &
        $\mathrm{HSO}_{4}^{-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Ammonium &
        $\mathrm{NH}_{4}^{+}$ &
        Dihydrogen phosphate &
        ${\mathrm{H}}_{2}\mathrm{PO}_{4}^{-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Nitrate &
        $\mathrm{NO}_{3}^{-}$ &
        Hypochlorite &
        ${\mathrm{ClO}}^{-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Hydrogen carbonate &
        $\mathrm{HCO}_{3}^{-}$ &
        Acetate (ethanoate) &
        ${\mathrm{CH}}_{3}{\mathrm{COO}}^{-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Phosphate &
        $\mathrm{PO}_{4}^{3-}$ &
        Oxalate &
        ${\mathrm{C}}_{2}\mathrm{O}_{4}^{2-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Chlorate &
        $\mathrm{ClO}_{3}^{-}$ &
        Oxide &
        ${\mathrm{O}}^{2-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Cyanide &
        ${\mathrm{CN}}^{-}$ &
        Peroxide &
        $\mathrm{O}_{2}^{2-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Chromate &
        $\mathrm{CrO}_{4}^{2-}$ &
        Sulphide &
        ${\mathrm{S}}^{2-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Permanganate &
        $\mathrm{MnO}_{4}^{-}$ &
        Sulphite &
        $\mathrm{SO}_{3}^{2-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Thiosulphate &
        ${\mathrm{S}}_{2}\mathrm{O}_{3}^{2-}$ &
        Manganate &
        $\mathrm{MnO}_{4}^{2-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
        Phosphide &
        ${\mathrm{P}}^{3-}$ &
        Hydrogen phosphate &
        $\mathrm{HPO}_{4}^{3-}$% make-rowspan-placeholders
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
    \end{xtabular}
      \end{center}
...
\label{m38689*secfhsst!!!underscore!!!id768}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 5.10:  Formulae of ionic compounds }
        ...
        \item  
        \label{m38689*id144691}Potassium iodide contains the ions $\mathrm{K}{}^{+}$ ($\mathrm{valency}=1$; $\mathrm{charge}=+1$) and $\mathrm{I}{}^{-}$ ($\mathrm{valency}=1$; $\mathrm{charge}=-1$). In order to balance the charge in a single molecule, one atom of potassium will be needed for every one atom of iodine.\par 
        \item  
        \label{m38689*id144729}The chemical formula for potassium iodide is therefore:\par 
        \label{m38689*id144732}$\mathrm{KI}$
        \par 
\end{enumerate}
    \end{exercise}
    \end{mdframed}
...
\par
    ...
    \noindent\textbf{Exercise 5.11:  Formulae of ionic compounds }
        ...
        \item  
        \label{m38689*id144792}$\mathrm{Na}{}^{+}$ (valency = 1; charge = +1) and $\mathrm{SO}_{4}^{2-}$($\mathrm{valency}=2$; $\mathrm{charge}=-2$).\par 
        \item  
        ...
        \label{m38689*id144854}$\mathrm{Na}{}_{2}\mathrm{SO}{}_{4}$
        \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
\par
    ...
    \noindent\textbf{Exercise 5.12:  Formulae of ionic compounds }
        ...
        \item  
        \label{m38689*id144953}Calcium hydroxide contains the ions ${\mathrm{Ca}}^{2+}$ ($\mathrm{charge}=+2$) and $\mathrm{OH}{}^{-}$ ($\mathrm{charge}=-1$). In order to balance the charge in a single molecule, two hydroxide ions will be needed for every ion of calcium.\par 
        \item  
        \label{m38689*id145000}The chemical formula for calcium hydroxide is therefore:\par 
        \label{m38689*id145004}$\mathrm{Ca\left(OH\right)}{}_{2}$
        \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
\begin{tabular}{cc}
	...
	\begin{minipage}{0.85\textwidth}
	\begin{note}
      {note: }Notice how in the last example we wrote ${\mathrm{OH}}^{-}$ inside brackets. We do this to indicate that ${\mathrm{OH}}^{-}$ is a complex ion and that there are two of these ions bonded to one calcium ion.
	\end{note}
	\end{minipage}
	\end{tabular}
	\par
