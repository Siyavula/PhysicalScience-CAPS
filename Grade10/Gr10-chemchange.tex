...
\item Solid ammonium carbonate decomposes to form three gaseous products.
        \end{enumerate}
 \par \begin{tabular}[h]{cccccc}
 (1.) ljf  &  (2.) ljg   &  (3.) lj7  &  (4.) ljA  &    &   &   &   &   &   & \end{tabular}
\end{exercises}
...
%Q4
\item The following diagrams represent the combustion of ethane ($\text{CH}_6$). Complete the diagrams and write a balanced equation for the reaction. Indicate the state symbols. \\
