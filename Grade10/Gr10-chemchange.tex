...
\end{table}
\Tip{Iron is a metal, when we represent it in a balanced chemical equation, we write only $\mathsf{Fe}$. Sulphur occurs as $\mathsf{S}_{8}$ but we write only the empirical formula: $\mathsf{S}$. We do this for all network structures. Writing formulae like this represents \textsl{one unit} of the compound or network strucutre.}
...
\label{m38726*eid0342}\nopagebreak\noindent{}
    \begin{equation*}
    \mathsf{Al}+{\mathsf{O}}_{2}\to {\mathsf{Al}}_{2}{\mathsf{O}}_{3}
      \end{equation*}
Take 1 ball of one colour. This represents a molecule of $\mathsf{Al}$. Take two balls of another colour and stick them together. This represents a molecule of ${\mathsf{O}}_{2}$. Place these molecules on your left. Now take two balls of one colour and three balls of another colour to form ${\mathsf{Al}}_{2}{\mathsf{O}}_{3}$. Place this compound on your right. On a piece of paper draw coloured circles to represent the balls. Draw a line down the center of the paper to represent the molecules on the left and on the right. 
\par 
...
\par
\label{m38726*id09873432}You should find that you need 4 balls of one colour for $\mathsf{Al}$ and 3 pairs of balls of another colour (i.e. 6 balls in total) for ${\mathsf{O}}_{2}$ on the left side. On the right side you should find that you need 2 clusters of balls for ${\mathsf{Al}}_{2}{\mathsf{O}}_{3}$.
We say that the balanced equation is:\\
    $4\mathsf{Al}+3{\mathsf{O}}_{2}\to 2{\mathsf{Al}}_{2}{\mathsf{O}}_{3}$
\item Use jelly tots and toothpicks to build the following chemical equation. Make sure that your atoms are balanced. Use the same colour jelly tots for the same atoms.\\
${\mathsf{C} + {\mathsf{H}}_{2}\mathsf{O} \to {\mathsf{CO}}_{2} + {\mathsf{CO}} + \mathsf{H}_{2}$ \\
Add compounds until the atoms are balanced. Write the equation down and use a coefficent to indicate how many compounds you used, for example if you had to use three water molecules then write $3{\mathsf{H}}_{2}\mathsf{O}$ 
\item Use ball and stick drawings to balance the atoms in the following reaction: \\
${\mathsf{NH}}_{3} + {\mathsf{O}}_{2} \to {\mathsf{NO}} + \mathsf{H}_{2}\mathsf{O}$ \\
Use your drawings to write a balanced chemical equation for the reaction.
\item Lead ($\mathsf{Pb}$), lead (IV) oxide (${\mathsf{PbO}}_{2}$) and sulphuric acid (${\mathsf{H}}_{2}{\mathsf{SO}}_{4}$) are used in car batteries. The following reaction takes place:
$\mathsf{Pb} + \mathsf{PbO}_{2} + \mathsf{H}_{2}\mathsf{SO}_{4} \to {\mathsf{PbSO}}_{4} + {\mathsf{H}}_{2}\mathsf{O}$ \\
Cut out circles from four different colours of paper to represent each of the atoms. Build a few of the compounds ($\mathsf{Pb}$ $\mathsf{PbO}_{2}$ $\mathsf{H}_{2}\mathsf{SO}_{4}$). These are the reactants. Do not build the products. Rearrange the atoms so that the products are formed. Add more reactants if needed to balance the atoms. (e.g. you will need two $\mathsf{H}_{2}\mathsf{SO}_{4}$ molecules). Use what you have learnt to write a balanced equation for the reaction.
\end{enumerate}
 \begin{center}
...
\label{m38726*uid16}\item STEP 6 (we will look at this a little later): Add any extra details to the equation e.g. phase symbols.
\end{itemize}
\par
...
$\mathsf{N}_{2} \mathsf{(g)} + \mathsf{H}_{2} \mathsf{(g)} \to \mathsf{NH}_{3} \mathsf{(g)}$
\end{enumerate}
  \label{m38726**end}
...
\end{exercises}
    ...
    \nopagebreak
      ...
      \label{m38727*id65920}The state (phase) of the compounds can be expressed in the chemical equation. This is done by placing the correct label on the right hand side of the formula. The following four labels can be used:\par 
      \label{m38727*id65925}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m38727*uid27}\item $\mathsf{(g)}$ for gaseous compounds
\label{m38727*uid28}\item $\mathsf{(\ell)}$ for liquids
\label{m38727*uid29}\item $\mathsf{(s)}$ for solid compounds
\label{m38727*uid30}\item $\mathsf{(aq)}$ for an aqueous (water) solution
\end{enumerate}
\label{m38727*eip-536}To show that heat is needed for a reaction, a Greek delta ($\Delta $) is placed above the arrow.
...
\label{m38727*uid35}\item When calcium chloride solution is mixed with silver nitrate solution, a white precipitate (solid) of silver chloride appears. Calcium nitrate ($\mathsf{{Ca(NO}}_{3}\mathsf{)}}_{2}$) is also produced in the solution.
...
\item The following diagrams represent the combustion of ethane ($\mathsf{C}_\mathsf{H}_6$). Complete the diagrams and write a balanced equation for the reaction. Indicate the state symbols. \\
...
${\mathsf{N}}_{2}{\mathsf{O}}_{5}\to {\mathsf{NO}}_{2}+{\mathsf{O}}_{2}$ Draw submicroscopic diagrams to represent this reaction.
...
\label{m38727*id6243}\nopagebreak\noindent{}
    \begin{equation}
    \begin{array}{c}{\mathsf{H}}_{2}\mathsf{S}+{\mathsf{O}}_{2}\to {\mathsf{SO}}_{2}+{\mathsf{H}}_{2}\mathsf{O}\\ {\mathsf{H}}_{2}\mathsf{S}+{\mathsf{SO}}_{2}\to \mathsf{S}+{\mathsf{H}}_{2}\mathsf{O}\end{array}
      \end{equation}
