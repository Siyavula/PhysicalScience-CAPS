...
% \end{enumerate}
%     \label{m38777*cid4}
% \par \raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} Vind die antwoord met die kort-kodes:
...
\end{enumerate}
    \label{m38779*cid8}
\par \raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} Vind die antwoorde met die kort-kodes:
 \par \begin{tabular}[h]{cccccc}
