...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
    ...
    \end{enumerate}
\end{enumerate}
\par \raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.pdf}} Vind antwoorde met die volgende kortkodes:
\par \begin{tabular}[h]{cccccc}
