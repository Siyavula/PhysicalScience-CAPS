...
\Definition{Verplasing}{ Verplasing is die verandering in 'n voorwerp se posisie. Dit is 'n vektor wat van die oorspronklike posisie ($\vec{x}_{i}$) na die finale posisie ($\vec{x}_{f}$) wys.\par
...
\end{center}
    \par
Daarbenewens kan 'n voorwerp op 'n plek begin en terugkeer na dieselfde plek en 'n snelheid van 0 h\^e maar teen 'n nie-nul spoed beweeg. \par
