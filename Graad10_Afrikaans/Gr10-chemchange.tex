    ...
    \nopagebreak
            \label{m38721} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10059 )} \par 
...
Add compounds until the atoms are balanced. Write the equation down and use a coefficent to indicate how many compounds you used, for example if you had to use three water molecules then write $3{\text{H}}_{2}\text{O}$ 
...
\item Lead ($\text{Pb}$), lead (IV) oxide (${\text{PbO}}_{2}$) and sulphuric acid (${\text{H}}_{2}{\text{SO}}_{4}$) are used in car batteries. The following reaction takes place:
...
\end{exercises}
    ...
    \nopagebreak
      ...
      \label{m38727*id65925}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m38727*uid27}\item $\text{(g)}$ for gaseous compounds
\label{m38727*uid28}\item $\text{(\ell)}$ for liquids
\label{m38727*uid29}\item $\text{(s)}$ for solid compounds
\label{m38727*uid30}\item $\text{(aq)}$ for an aqueous (water) solution
\end{enumerate}
...
\item The following diagrams represent the combustion of ethane ($\text{C}_\text{H}_6$). Complete the diagrams and write a balanced equation for the reaction. Indicate the state symbols. \\
...
${\text{N}}_{2}{\text{O}}_{5}\to {\text{NO}}_{2}+{\text{O}}_{2}$ Draw submicroscopic diagrams to represent this reaction.
