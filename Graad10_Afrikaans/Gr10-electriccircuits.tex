...
\section{Serie-weerstande}

\begin{mdframed}
Wanneer ons weerstande in serie in 'n stroombaan sit: 
\begin{itemize}
 \item is daar net een pad waarin die stroom kan vloei, dus \textbf{is die stroom dieselfde op elke punt in die stroombaan}.
 \item die potensiaalverskil word \textbf{gedeel} oor die weerstande. Die potensiaal oor die battery in die stroombaan is gelyk aan die som van die weerstande in serie.
\begin{equation*}
...
weerstand en 'n battery. \textbf{Die stroom is dieselfde orals in 'n serie-stroombaan}. Aan die regterkant het ons 'n tweede weerstand in serie
...
\begin{mdframed}
Wanneer ons weerstande in parallel plaas in 'n stroombaan:
\begin{itemize}
 \item is daar meer as een pad vir stroom om te volg, dus \textbf{verdeel die stroom oor die verskillende paaie}.
 \item Die spanning is \textbf{dieselfde} oor die weerstande. Die spanning oor die battery in die stroombaan is dieselfde as die spanning oor elkeen van die parallelle weerstande.
\begin{equation*}
...
\item As jy 'n stroombaan het wat bestaan uit 4 weerstande in serie van gelyke weerstand en die totale spanning oor almal is 17~V, wat is die spanning oor elkeen?

\item As jy 'n stroombaan het wat bestaan uit 4 weerstande in parallel van gelyke weerstand en die totale spanning oor almal is 17~V, wat is die spanning oor elkeen?

\item In 'n stroombaan wat bestaan uit 'n battery en 3 weerstande in serie, wat is die spanning oor die eerste weerstand as die spanning oor die battery 12~V is en die spanning oor die ander twee weerstande 3~V en 2~V is?

\item Daar is 3 weerstande in parallel met weerstande van 3~$\Omega$, 4~$\Omega$ en 11~$\Omega$.  Wat is die totale weerstand van die parallelle kombinasie?

\item Dieselfde 3 weerstande as in die vorige vraag word nou in serie gekoppel. Wat is die totale weerstand van die serie kombinasie?

\item Die totale weerstand van twee weerstande in parallel is 3~$\Omega$, Die een weerstand se waarde is 5~$\Omega$. Wat is die weerstand van die ander een?

\item In 'n serie stroombaan is daar 3 weerstande wat spannings van 2~V, 5~V and 8~V oor hulle het, wat is die spanning oor die battery in die stroombaan?

\item In 'n parallel stroombaan is daar 3 weerstande met spannings van 2~V, 2~V and 2~V oor hulle, wat is die spanning oor die battery in die stroombaan?
