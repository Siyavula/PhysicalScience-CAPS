...
\label{m37830*eip-356}Hierdie simulasie wys die Aarde se magnetiese veldlyne en 'n kompas.$ \begin{array}{cccccccccccc}   \includegraphics[width=0.5cm]{col11305.imgs/summary_simulation.png} &   \end{array} $ \hspace{1 pt}\raisebox{-5 pt}{} {(Simulasie: lb9) } \par 
