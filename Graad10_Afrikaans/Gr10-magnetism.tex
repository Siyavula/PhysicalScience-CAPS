...
\label{m37830}
    \section{Inleiding}
            \label{m37830*cid2} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11305.imgs/summary_www.png}} {(seksie kortkode: P10064 )} \par 
...
\section*{Magnetiese velde}
            \label{m37830*cid3} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11305.imgs/summary_www.png}} {(seksie kortkode: P10065 )} \par 
...
\section*{Permanente magnete}
            \nopagebreak
            \label{m37830*cid4} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \includegraphics[width=0.75cm]{col11305.imgs/summary_fullmarks.png} &   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{} {(seksie kortkode: P10066 )} \par 
      \label{m37830*uid16}
...
\subsection*{Magnetiese retensie en magnetiese materiale [vir interessantheidsonthalwe]}
...
\section{Die kompas en die Aarde se magneetveld}
            \nopagebreak
            \label{m37830*cid5} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \includegraphics[width=0.75cm]{col11305.imgs/summary_simulation.png} &   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{} {(seksie kortkode: P10067 )} \par 
\begin{minipage}{.5\textwidth}      
...
Die Aarde het dus twee stelle noord pole en suid pole: \texbf{geografiese pole} en \textbf{magnetiese pole}. \par
...
\end{pspicture} 
 ...
 \end{figure}       
        \par 
        \label{m37830*id129590}The Earth's magneetic field is thought to be caused by flowing liquid metals
in the outer core which causes electric currents and a magneetic field. From the picture
you can see that the direction of magneetic north and true north are not
...
the \textbf{magneetic north pole} (which is where a compass will point). However,
the magneetic poles shift slightly all the time.\par 
        \label{m37830*id129612}Another interesting thing to note is that if we think of the Earth  as a big
bar magneet, and we know that magneetic field lines always point
\textsl{from north to south}, then the compass tells us that what we call the
\textsl{magneetic north pole} is actually the \textsl{south pole} of the bar magneet!\par 
\IFact{  \label{m37830*id129640}The direction of the Earth's magneetic field flips direction about once every
200~000 years! You can picture this as a bar magneet whose north and south pole
periodically switch sides. The reason for this is still not fully understood.\par 
	}
\label{m37830*fs-id1166240854705}
            \subsection{Phenomena related to the Earth's magneetic field }
            \nopagebreak
\label{m37830*fs-id7505799}
            \subsection{The importance of the magneetic field to life on Earth }
            \nopagebreak
\label{m37830*fs-id1166211137674}The Earth's magneetic field is very important for humans and other animals on Earth because it protects us from being bombarded (hit) by high energy charged particles which are emitted by the Sun. The stream of charged particles (mainly positively charged protons and negatively charged electrons) coming from the sun is called the solar wind. When these particles come close to the Earth, they become trapped by the Earth's magneetic field and cannot shower down to the surface where they can harm living organisms. 
...
\begin{minipage}{.5\textwidth}
 \begin{center}
  \textbf{Visualisation of the magneetosphere}\par
  \includegraphics[width=.8\textwidth]{photos/magneetosphere.jpg}\par
  \textit{Graphic by NASA Goddard Photo and Video on Flickr}
 \end{center}
\end{minipage}
\begin{minipage}{.5\textwidth}

The region above Earth's atmosphere in which charged particles are affected by Earth's magneetic field is called the magneetosphere. 
Relatively often, in addition to the usual solar wind, the Sun may eject a large bubble of material (protons and electrons) with its own magneetic field from its outer atmosphere. Sometimes these bubbles travel towards the Earth where their magneetic fields can join with Earth's magneetic field. When this happens a huge amount of energy is released into the Earth's magneetosphere, causing a geomagneetic storm. These storms cause rapid changes in the Earth's magneetosphere which in turn may affect electric and magneetic systems on the Earth such as power grids, cellphone networks, and other electronic systems.
\end{minipage}
\par 
...
Another effect caused by the Earth's magneetic field is the spectacular Northern and Southern Lights, which are also called the Aurora Borealis and the Aurora Australis respectively.\par
\begin{minipage}{.6\textwidth}
 When charged particles from the solar wind reach the Earth's magneetosphere, they spiral along the magneetic field lines towards the North and South poles. If they collide with particles in the Earth's atmosphere, they can cause red or green lights which stretch across a large part of the sky and which is called the aurora. 
\begin{center}
...
\par 
\label{m37830*eip-356}This simulation shows you the Earth's magneetic field and a compass.$ \begin{array}{cccccccccccc}   \includegraphics[width=0.5cm]{col11305.imgs/summary_simulation.png} &   \end{array} $ \hspace{1 pt}\raisebox{-5 pt}{} {(Simulation: lb9) } \par 
\section{ Summary}
            \nopagebreak
            \label{m37830*cid6} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \includegraphics[width=0.75cm]{col11305.imgs/summary_video.png} &   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{} {(seksie kortkode: P10068 )} \par 
...
\label{m37830*uid24}\item Some substances can be easily magneetised.
\label{m37830*uid25}\item Like poles repel each other and unlike poles attract each other.
\label{m37830*uid26}\item The Earth also has a magneetic field.
\label{m37830*uid27}\item A compass can be used to find the magneetic north pole and help us find our direction.
\end{enumerate}
        \label{m37830*eip-568}This video provides a summary of the work covered in this chapter.
    \setcounter{subfigure}{0}
	\begin{figure}[H] % horizontal\label{m37830*magneets-1}
    \textnormal{Khan academy video on magneets}\vspace{.1in} \nopagebreak
 ...
 \end{figure}       \par 
    \section{ End of chapter exercises}
            \nopagebreak
            \label{m37830*cid7} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11305.imgs/summary_www.png}} {(seksie kortkode: P10070 )} \par 
