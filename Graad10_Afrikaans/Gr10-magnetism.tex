...
\nopagebreak
Omdat die domeine in  'n permanente magneet in  'n sekere rigting opgelyn is, het die magneet  'n paar teenoorgestelde pole, genoem \textbf{noord} (verkort na \textbf{N}) en \textbf{suid} (verkort na \textbf{S}). Selfs al word die magneet opgesny in klein deeltjies, sal elke deel nogsteeds \textbf{beide}  'n noord- en suidpool h\^e. Die magnetiese pole kom \textsl{altyd} voor in pare. In die natuur kry ons nooit  'n noord magnetiese pool of suid magnetiese pool op hul eie nie.
