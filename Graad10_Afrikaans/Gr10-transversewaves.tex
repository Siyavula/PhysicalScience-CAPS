    ...
    \section{Introduction}
            \nopagebreak
            \label{m38806*cid2} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10040 )} \par 
...
A enlarged version of the ripple tank can be seen in a real life example of a Kreepy Krauly\textregistered\ making waves in a pool because of the regular vibrations. The Kreepy Krauly\textregistered\ was invented in South Africa by Ferdinand Chauvier and his son Daniel.
\end{minipage}
...
\IFact{
A tsunami is a series of sea waves caused by an underwater earthquake, landslide, or volcanic eruption. When the ocean is deep, tsunamis may be less than a 30~cm high on the ocean’s surface and can travel at speeds up to 700~$\text{km}\cdot \text{hr}^{-1}$.
...
{%question
    \label{m38806*id318469}If the crest of a wave measures $2~\text{m}$ above the still water mark in the harbour, what is the amplitude of the wave? \par 
}
{%solution
...
\westep{Determine the amplitude}{  
        \label{m38806*id318492}The definition of the amplitude is the height of a crest above the equilibrium position. The still water mark is the height of the water at equilibrium and the crest is $2\phantom{\rule{2pt}{0ex}}\text{m}$ above this, so the amplitude is $2\phantom{\rule{2pt}{0ex}}\text{m}$. \par 
}
}
\end{wex}
...
Symbol: $f$ \hspace{2cm} S.I. Unit: $\text{s}^{-1}$
    ...
    \noindent
      \label{m38806*uid21}
       ...
       \Definition{\textbf{Wave speed }}{Wave speed is the distance a wave travels per unit time. \par 
	    Symbol: $v$ \hspace{2cm} S.I. Unit: $\text{m}\cdot \text{s}^{-1}$
         } 
...
\Definition{Wave equation}{\begin{equation}\nonumber
...
\section{Summary}
            \nopagebreak
            \label{m38806*cid6} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10044 )} \par 
...
\end{table}
    \begin{eocexercises}{Waves}
            \nopagebreak
            \label{m38806*cid7} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10045 )} \par 
