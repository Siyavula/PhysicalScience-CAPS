...
\Tip{Wanneer ons kombinasies van basiese SI-eenhede skryf sit on  'n kolletjie ($\ensuremath{\cdot}$) tussen die eenhede om te wys dat verskillende basiese eenhede gebruik word. Die simbool vir meter per sekonde word, byvoorbeeld, eintlik as m$\ensuremath{\cdot}$s${}^{-1}$, geskryf en nie ms${}^{-1}$ of m/s nie. Alhoewel die laaste twee wel in toetse en eksamens aanvaar word, gaan ons net die eerste skryfwyse in hierdie boek gebruik.}
...
\end{enumerate}
\subsection*{Koers, eweredigheid en verhouding}
...
\hline}
\tablelasttail{\hline}
  \begin{supertabular}{|l|m{3cm}|m{3cm}|}\hline
%    \textbf{Item} & \textbf{Photo} & \textbf{Sketch} \\ \hline
