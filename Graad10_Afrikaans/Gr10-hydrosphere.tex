...
\begin{tabular}{cc}
	...
	\begin{note}
      {note: }The total mass of the hydrosphere is approximately $1,4~{\times}{10}^{18} ~~ \text{tonnes}$! (The volume of one tonne of water is approximately 1 cubic metre (this is about 900 A4 textbooks!))
	\end{note}
	\end{minipage}
	\end{tabular}
	\par
