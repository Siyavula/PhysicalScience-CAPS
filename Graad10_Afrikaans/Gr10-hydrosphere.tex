...
\Note{Die totale massa van die hidrosfeer is ongeveer $1,4~{\times}{10}^{18} ~~ \text{tonnes}$! (Die volume van 1 ton water is ongeveer 1 kubieke meter – dit is ongeveer 900 A4 handboeke!)}
...
\summary{ccc}
      ...
      \label{m38138*id342453}\begin{itemize}[noitemsep]
            \label{m38138*uid92}\item Die \textbf{hidrosfeer} sluit al die water wat op die Aarde is in. Bronne van water sluit varswater (bv. rivere en mere), soutwater (bv. oseane), grondwater (bv. boorgate) en waterdamp in. Ys (bv. gletsers)  is ook deel van die hidrosfeer.
...
\item Skryf ‘n opstel van een bladsy oor die belangrikheid van water en wat ons kan doen om te verseker dat ons oor 50 jaar nog steeds drinkbare water het.
\end{enumerate}
  \label{m38138**end}
