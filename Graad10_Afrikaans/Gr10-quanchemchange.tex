...
\IFact{Die oorspronklike hipotese wat deur Amadeo Avogadro voorgestel is, is dat "gelyke volumes van gasse, by dieselfde temperatuur en druk, dieselfde aantal molekules bevat”. Sy idees is nie deur die wetenskaplike gemeenskap aanvaar nie en dit was eers vier jaar ná sy dood dat sy oorspronklike hipotese aanvaar is en dat dit bekend geword het as 'Avogadro se wet’. Ter ere van sy bydrae tot wetenskap is die aantal deeltjies in 'n mol bekend as Avogadro se getal. Ons gebruik Avogadro se getal en die mol in chemie om ons te help kwantifiseer wat gebeur in  'n chemiese reaksie. Die mol is 'n baie spesiale getal.}
...
$\text{Suurstof}=4 \times 16,0 = 64,0 \text{ g} \cdot \text{mol}^{-1}$
      \westep{Gebruik die inligting uit die vorige stap om die molekul\^{e}re massa van swaelsuur te bereken.}
...
\section{Hoeveelheid van stowwe}
 ...
 \Definition{Mol\^{e}re volume van gasse} {Een mol gas beslaan $22,4{\text{ dm}}^{3}$ by standard temperatuur en pressure. } 
...
\westep{Skryf die gebalanseerde vergelyking neer}
    ...
    \text{n}=\frac{\text{m}}{\text{M}}=\frac{5,6 \text{ g}}{55,8 \text{ g} \cdot \text{mol}^{-1}} = 0,1\text{ mol}
      \end{equation*}
      \westep{Vind die molverhouding} Ons vind die molverhouding tussen wat gegee is en wat gelewer word deur die reaksie. Vanuit die vergelyking kan ons aflei dat $1 \text{ mol}$ $\text{Fe}$  'n opbrengs van  $1 \text{mol}$ $\text{FeS}$. Gevolglik sal $0,1\text{ mol}$ yster in die reaktanse $0,1 \text{ mol}$ ystersulfied in die produk oplewer. 
...
\label{m38717*secfhsst!!!underscore!!!id695}
      \begin{wex}{ Berekening van die massa van reagense en produkte }
{
%problem
