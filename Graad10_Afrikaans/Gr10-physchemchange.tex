    ...
    \label{m38709*cid1}
            \section{Inleiding}
            \nopagebreak
            \label{m38709} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10056 )} \par 
...
\par \raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} Vind die antwoorde met die shortcodes:
