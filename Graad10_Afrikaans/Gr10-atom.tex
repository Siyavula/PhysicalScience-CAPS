...
\uput[r](4,1){\Large{elektron orbit}}
\end{pspicture}
}
\begin{minipage}{.8\textwidth}
...
% \item The energy of elektrons in an atoom is \textbf{quantised}. Electrons occur in specific energy levels around an atom's nucleus.
