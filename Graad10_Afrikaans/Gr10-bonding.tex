...
Each oxygen atom has 8 electrons, and their electron configuration is $\text{[He]}2\textsf{s}^{2}2\textsf{p}^{4}$. 
...
\Note{Chlorine is a diatomic molecule and so for it to take part in ionic bonding, it must first break up into two atoms of chlorine. Sodium is part of a metallic lattice and the individual atoms must first break away from the lattice.}
    ...
    \begin{equation}
    2\text{Mg}+{\text{O}}_{2}\to 2\text{MgO}\tag{5.2}
      \end{equation}
...
$\text{Cl}$ ions is 1:1. The structure of the crystal lattice is shown in figure~\ref{fig:atomcomb:crystal lattice}.\par 
