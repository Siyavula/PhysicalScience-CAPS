\chapter{Longitudinale golwe}\fancyfoot[LO,RE]{Fisika: Golwe, klank en lig}
    ...
    \nopagebreak
            \label{m38782} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \includegraphics[width=0.75cm]{col11305.imgs/summary_fullmarks.png} &   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{} {(afdeling kortkode: P10046 )} \par 
    ...
    \label{m38782*cid3}
            ...
            \nopagebreak
\par
\Definition{   \label{id2444157}\textbf{Longitudinale golwe }} { \label{m38782*meaningfhsst!!!underscore!!!id64}
...
\Definition{   \label{id2399629}\textbf{Kompressies}} { \label{m38782*meaningfhsst!!!underscore!!!id105}
      'n \textbf{Kompressie} is 'n deel van 'n longitudinale golf waar die deeltjies van die medium naaste aan mekaar is.
       } 
\par
\Definition{   \label{id2399653}\textbf{Verdunnings}} { \label{m38782*meaningfhsst!!!underscore!!!id108}
...
\end{center}
 \end{figure}       
      \label{m38782*uid8}
            ...
            \nopagebreak
\par
 \Definition{   \label{id2445839}\textbf{Golflengte}} { \label{m38782*meaningfhsst!!!underscore!!!id125}
...
\end{center}
 \end{figure}       
      \label{m38782*uid10}
            ...
            \nopagebreak
            \par
\Definition{   \label{id2445953}\textbf{ Periode }} { \label{m38782*meaningfhsst!!!underscore!!!id143}
...
\par
 \Definition{   \label{id2445977}\textbf{ Frekwensie }} { \label{m38782*meaningfhsst!!!underscore!!!id146}
...
\Definition{\textbf{Golfspoed}}{Golfspoed is die afstand per tydseenheid waarmee die golf deur die medium beweeg. Golfspoed word deur die simbool $v$ voorgestel en word gewoonlik in $\text{m}\cdot \text{s}^{-1}$ gemeet.\par 
         } 
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11305.imgs/summary_www.png}} Vind die antwoorde met die volgende kortkodes:
