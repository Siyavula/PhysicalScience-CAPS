...
\end{exercises}
    ...
    \nopagebreak
            \label{m38813} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.eps}} {(section shortcode: P10092 )} \par 
    \label{m38813*cid7}
...
\Definition{Equality of vectors}{Two vectors are equal if they have the same magnitude and direction.}
      \label{m38813*uid35}
...
\Definition{Negative vector}{A negative vector is a vector that has the same magnitude, but opposite direction to that of the given vector.}
